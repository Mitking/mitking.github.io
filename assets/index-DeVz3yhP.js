import { importShared } from './__federation_fn_import-6jorU3Le.js';
import _sfc_main, { o as onPopupReopen, w as windowWidth, a as windowHeight, u as useRect, c as createNamespace, t as truthProp, b as useChildren, d as withInstall, n as numericProp, m as makeStringProp, e as extend, g as getSizeStyle, f as addUnit, B as BORDER_SURROUND, p as preventDefault, I as Icon, h as useParent, i as useExpose, j as unknownProp, k as Badge, P as Popup, l as pick, q as popupSharedProps, r as makeArrayProp, H as HAPTICS_FEEDBACK, s as popupSharedPropKeys, v as isDef, x as clamp, y as makeRequiredProp, z as useTouch, A as useEventListener, C as raf, D as cancelRaf, E as getScrollTop, F as setScrollTop, G as inBrowser, J as onMountedOrActivated, K as makeNumericProp, L as useScrollParent, M as unitToPx, N as getZIndexStyle, O as isHidden, Q as usePageVisibility, R as doubleRaf, S as BORDER_TOP_BOTTOM, T as setRootScrollTop, U as getElementTop, V as callInterceptor, W as flat, X as isSameValue, Y as BORDER_UNSET_TOP_BOTTOM, Z as FORM_KEY, _ as getRootScrollTop, $ as isObject, a0 as isFunction, a1 as isPromise, a2 as CUSTOM_FIELD_INJECTION_KEY, a3 as toArray, a4 as formatNumber, a5 as resetScroll, a6 as makeNumberProp, a7 as mountComponent, a8 as usePopupState, a9 as useCustomFieldValue, aa as isMobile, ab as getScrollParent$1, ac as padZero, ad as useToggle, ae as isDate, af as useScopeId, ag as useLazyRender, ah as stdin_default$1L, ai as useCountDown, aj as noop, ak as BORDER_TOP, al as BORDER_LEFT, am as useClickAway, an as getContainingBlock$1, ao as stdin_default$1M, ap as useLockScroll, aq as BORDER, ar as LONG_PRESS_START_TIME, as as BORDER_BOTTOM, at as stopPropagation, au as BORDER_RIGHT, av as addNumber, aw as Locale, ax as Notify, ay as Overlay, az as showNotify, aA as useMqttStore, aB as useUserStore, aC as createPinia } from './__federation_expose_App-DPKkHJ1Q.js';
import { n as normalizeClass, s as stringifyStyle, a as normalizeStyle } from './shared.esm-bundler-z25H-pmD.js';
...
const {ref: ref$S,onMounted: onMounted$h,nextTick: nextTick$p,watch: watch$G} = await importShared('vue');
...
function usePlaceholder(contentRef, bem) {
  ...
  return (renderContent) => _createVNode$1K("div", {
...
const {defineComponent: defineComponent$1H,ref: ref$R,createVNode:_createVNode$1J} = await importShared('vue');
...
const {computed: computed$S,defineComponent: defineComponent$1G,createVNode:_createVNode$1I} = await importShared('vue');
const [name$1E, bem$1y] = createNamespace("loading");
const SpinIcon = Array(12).fill(null).map((_, index) => _createVNode$1I("i", {
  "class": bem$1y("line", String(index + 1))
}, null));
const CircularIcon = _createVNode$1I("svg", {
  "class": bem$1y("circular"),
  "viewBox": "25 25 50 50"
}, [_createVNode$1I("circle", {
  "cx": "50",
  "cy": "50",
  "r": "20",
  "fill": "none"
...
var stdin_default$1J = defineComponent$1G({
  ...
  setup(props, {
    ...
    const spinnerStyle = computed$S(() => extend({
      color: props.color
    }, getSizeStyle(props.size)));
    const renderIcon = () => {
      const DefaultIcon = props.type === "spinner" ? SpinIcon : CircularIcon;
      return _createVNode$1I("span", {
...
const {defineComponent: defineComponent$1F,createVNode:_createVNode$1H} = await importShared('vue');
...
var stdin_default$1I = defineComponent$1F({
  ...
  setup(props, {
    ...
    const renderLoadingIcon = () => {
      ...
      return _createVNode$1H(Loading, {
    ...
    const renderIcon = () => {
      ...
      if (slots.icon) {
        return _createVNode$1H("div", {
          "class": bem$1x("icon")
        }, [slots.icon()]);
      }
      if (props.icon) {
        return _createVNode$1H(Icon, {
          "name": props.icon,
          "class": bem$1x("icon"),
    ...
    return () => {
      ...
      const classes = [bem$1x([type, size, {
        plain,
        block,
        round,
        square,
...
const {computed: computed$R,defineComponent: defineComponent$1E,createVNode:_createVNode$1G} = await importShared('vue');
...
var stdin_default$1H = defineComponent$1E({
  ...
  setup(props, {
    ...
    const isFirst = computed$R(() => {
      if (parent) {
        const prev = parent.children[index.value - 1];
        return !(prev && "isButton" in prev);
      }
    });
    const isLast = computed$R(() => {
      if (parent) {
...
const {defineComponent: defineComponent$1D,mergeProps:_mergeProps$v,createVNode:_createVNode$1F} = await importShared('vue');
...
var stdin_default$1G = defineComponent$1D({
  ...
  setup(props, {
    ...
    const renderIcon = () => {
      ...
      if (slots.icon) {
        return _createVNode$1F(Badge, _mergeProps$v({
          "dot": dot,
          "class": bem$1v("icon"),
          "content": badge
        }, badgeProps), {
...
const {nextTick: nextTick$o,defineComponent: defineComponent$1C,createVNode:_createVNode$1E,mergeProps:_mergeProps$u} = await importShared('vue');
...
var stdin_default$1F = defineComponent$1C({
  ...
  setup(props, {
    ...
    const renderHeader = () => {
      if (props.title) {
        return _createVNode$1E("div", {
          "class": bem$1u("header")
        }, [props.title, props.closeable && _createVNode$1E(Icon, {
    ...
    const renderActionContent = (action, index) => {
      if (action.loading) {
        return _createVNode$1E(Loading, {
      ...
      return [_createVNode$1E("span", {
        "class": bem$1u("name")
      }, [action.name]), action.subname && _createVNode$1E("div", {
    ...
    return () => _createVNode$1E(Popup, _mergeProps$u({
      "class": bem$1u(),
      "position": "bottom",
      ...
      default: () => {
        var _a;
        return [renderHeader(), renderDescription(), _createVNode$1E("div", {
...
const {ref: ref$Q,computed: computed$Q,watchEffect: watchEffect$4,defineComponent: defineComponent$1B,createVNode:_createVNode$1D} = await importShared('vue');
...
var stdin_default$1E = defineComponent$1B({
  ...
  setup(props, {
    ...
    const currentIndex = computed$Q(() => getIndexByOffset(currentOffset.value));
    ...
    const renderOptions = () => {
      ...
      return props.options.map((option, index) => {
        ...
        return _createVNode$1D("li", data, [slots.option ? slots.option(option, index) : _createVNode$1D("div", childData, null)]);
      });
    };
...
const {defineComponent: defineComponent$1A,createVNode:_createVNode$1C} = await importShared('vue');
...
var stdin_default$1D = defineComponent$1A({
  ...
  setup(props, {
    ...
    const renderCancel = () => {
      var _a;
      const text = (_a = props.cancelButtonText) != null ? _a : t$k("cancel");
      if (!slots.cancel && !text) {
        return;
      }
      return _createVNode$1C("button", {
        "type": "button",
    ...
    const renderConfirm = () => {
      var _a;
      const text = (_a = props.confirmButtonText) != null ? _a : t$k("confirm");
...
const {onDeactivated: onDeactivated$3,onBeforeUnmount: onBeforeUnmount$4} = await importShared('vue');
function useVisibilityChange(target, onChange) {
  ...
  onDeactivated$3(unobserve);
  onBeforeUnmount$4(unobserve);
  onMountedOrActivated(observe);
}

const {ref: ref$N,watch: watch$E,computed: computed$P,nextTick: nextTick$n,reactive: reactive$f,defineComponent: defineComponent$1z,createVNode:_createVNode$1B} = await importShared('vue');
...
var stdin_default$1C = defineComponent$1z({
  ...
  setup(props, {
    ...
    const offset = computed$P(() => unitToPx(props.position === "top" ? props.offsetTop : props.offsetBottom));
    const rootStyle = computed$P(() => {
      if (isReset.value) {
        return;
      }
      const {
    ...
    watch$E(() => state.fixed, (value) => emit("change", value));
...
const {ref: ref$M,watch: watch$D,reactive: reactive$e,computed: computed$O,onMounted: onMounted$g,onActivated: onActivated$4,onDeactivated: onDeactivated$2,onBeforeUnmount: onBeforeUnmount$3,defineComponent: defineComponent$1y,nextTick: nextTick$m,createVNode:_createVNode$1A} = await importShared('vue');
...
var stdin_default$1B = defineComponent$1y({
  ...
  setup(props, {
    ...
    const count = computed$O(() => children.length);
    const size = computed$O(() => state[props.vertical ? "height" : "width"]);
    const delta = computed$O(() => props.vertical ? touch.deltaY.value : touch.deltaX.value);
    const minOffset = computed$O(() => {
      if (state.rect) {
    ...
    const maxCount = computed$O(() => size.value ? Math.ceil(Math.abs(minOffset.value) / size.value) : count.value);
    const trackSize = computed$O(() => count.value * size.value);
    const activeIndicator = computed$O(() => (state.active + count.value) % count.value);
    const isCorrectDirection = computed$O(() => {
      const expect = props.vertical ? "vertical" : "horizontal";
      return touch.direction.value === expect;
    });
    const trackStyle = computed$O(() => {
      const style = {
    ...
    watch$D(() => props.initialSwipe, (value) => initialize(+value));
    watch$D(count, () => initialize(state.active));
    watch$D(() => props.autoplay, autoplay);
    watch$D([windowWidth, windowHeight, () => props.width, () => props.height], resize);
    ...
    onBeforeUnmount$3(stopAutoplay);
    useEventListener("touchmove", onTouchMove, {
      target: track
    });
    return () => {
...
const {ref: ref$L,watch: watch$C,onMounted: onMounted$f,defineComponent: defineComponent$1x,createVNode:_createVNode$1z} = await importShared('vue');
...
const {ref: ref$K,watch: watch$B,computed: computed$N,reactive: reactive$d,nextTick: nextTick$l,onActivated: onActivated$3,defineComponent: defineComponent$1w,createVNode:_createVNode$1y} = await importShared('vue');
...
var stdin_default$1z = defineComponent$1w({
  ...
  setup(props, {
    ...
    const scrollable = computed$N(() => children.length > +props.swipeThreshold || !props.ellipsis || props.shrink);
    const navStyle = computed$N(() => ({
    ...
    const currentName = computed$N(() => {
      const activeTab = children[state.currentIndex];
      if (activeTab) {
        return getTabName(activeTab, state.currentIndex);
      }
    });
    const offsetTopPx = computed$N(() => unitToPx(props.offsetTop));
    const scrollOffset = computed$N(() => {
      if (props.sticky) {
    ...
    const renderHeader = () => {
      ...
      const Header = [_createVNode$1y("div", {
    ...
    watch$B(() => [props.color, props.duration, props.lineWidth, props.lineHeight], setLine);
    watch$B(windowWidth, resize);
    watch$B(() => props.active, (value) => {
      if (value !== currentName.value) {
        setCurrentIndexByName(value);
      }
    });
    watch$B(() => children.length, () => {
      if (state.inited) {
    ...
    }, [props.showHeader ? props.sticky ? _createVNode$1y(Sticky, {
      "container": root.value,
      "offsetTop": offsetTopPx.value,
      "onScroll": onStickyScroll
    }, {
      default: () => [renderHeader()]
    }) : renderHeader() : null, _createVNode$1y(stdin_default$1A, {
      "ref": contentRef,
...
const {inject,provide: provide$1,computed: computed$M} = await importShared('vue');
...
const useProvideTabStatus = (status) => {
  ...
  provide$1(TAB_STATUS_KEY, status);
  provide$1(
    ALL_TAB_STATUS_KEY,
    computed$M(() => {
...
const {computed: computed$L,defineComponent: defineComponent$1v,createVNode:_createVNode$1x} = await importShared('vue');
...
const TabTitle = defineComponent$1v({
  ...
  setup(props, {
    ...
    const renderText = () => {
      const Text = _createVNode$1x("span", {
        "class": bem$1n("text", {
          ellipsis: !props.scrollable
        })
      }, [slots.title ? slots.title() : props.title]);
      if (props.dot || isDef(props.badge) && props.badge !== "") {
        return _createVNode$1x(Badge, {
          "dot": props.dot,
          "content": props.badge,
...
const {computed: computed$K,nextTick: nextTick$k,reactive: reactive$c,onMounted: onMounted$e,defineComponent: defineComponent$1u,createVNode:_createVNode$1w} = await importShared('vue');
...
const {ref: ref$J,watch: watch$A,computed: computed$J,nextTick: nextTick$j,watchEffect: watchEffect$3,defineComponent: defineComponent$1t,getCurrentInstance: getCurrentInstance$3,mergeProps:_mergeProps$t,createVNode:_createVNode$1v,vShow:_vShow$9,withDirectives:_withDirectives$a} = await importShared('vue');
...
var stdin_default$1x = defineComponent$1t({
  ...
  setup(props, {
    ...
    const renderTitle = (onClickTab) => _createVNode$1v(TabTitle, _mergeProps$t({
      "key": id,
    ...
    return () => {
      ...
      if (animated || swipeable) {
        return _createVNode$1v(SwipeItem, {
          "id": id,
          "role": "tabpanel",
      ...
      return _withDirectives$a(_createVNode$1v("div", {
        "id": id,
        "role": "tabpanel",
        "class": bem$1l("panel"),
        "tabindex": show ? 0 : -1,
...
const {defineComponent: defineComponent$1s,Comment: Comment$1,Fragment: Fragment$1,createVNode:_createVNode$1u} = await importShared('vue');
...
var stdin_default$1w = defineComponent$1s({
  ...
  setup(props, {
    ...
    return () => {
      var _a, _b;
      let childNodes = (_b = (_a = slots.default) == null ? void 0 : _a.call(slots)) == null ? void 0 : _b.filter((node) => node.type !== Comment$1).map((node) => {
      ...
      return _createVNode$1u("div", {
        "class": bem$1k()
      }, [props.showToolbar ? _createVNode$1u(stdin_default$1D, {
        "title": props.title,
        "cancelButtonText": props.cancelButtonText,
        "confirmButtonText": confirmButtonText,
        "onConfirm": onConfirm,
        "onCancel": onCancel
      }, pick(slots, pickerToolbarSlots)) : null, _createVNode$1u(Tabs, {
        ...
        default: () => [props.tabs.map((title, index) => _createVNode$1u(Tab, {
          "title": title,
...
const {ref: ref$I,watch: watch$z,computed: computed$I,nextTick: nextTick$i,defineComponent: defineComponent$1r,createVNode:_createVNode$1t,mergeProps:_mergeProps$s} = await importShared('vue');
...
var stdin_default$1v = defineComponent$1r({
  ...
  setup(props, {
    ...
    linkChildren();
    const fields = computed$I(() => assignDefaultFields(props.columnsFieldNames));
    const optionHeight = computed$I(() => unitToPx(props.optionHeight));
    const columnsType = computed$I(() => getColumnsType(props.columns, fields.value));
    const currentColumns = computed$I(() => {
      const {
        columns
      } = props;
    ...
    const hasOptions = computed$I(() => currentColumns.value.some((options) => options.length));
    const selectedOptions = computed$I(() => currentColumns.value.map((options, index) => findOptionByValue(options, selectedValues.value[index], fields.value)));
    const selectedIndexes = computed$I(() => currentColumns.value.map((options, index) => options.findIndex((option) => option[fields.value.value] === selectedValues.value[index])));
    ...
    const renderColumnItems = () => currentColumns.value.map((options, columnIndex) => _createVNode$1t(stdin_default$1E, {
    ...
    const renderToolbar = () => {
      if (props.showToolbar && !parent) {
        return _createVNode$1t(stdin_default$1D, _mergeProps$s(pick(props, pickerToolbarPropKeys), {
          "onConfirm": confirm,
          "onCancel": cancel
    ...
    watch$z(() => props.modelValue, (newValues) => {
    ...
    watch$z(selectedValues, (newValues) => {
    ...
    return () => {
      ...
      return _createVNode$1t("div", {
        "class": bem$1t()
      }, [props.toolbarPosition === "top" ? renderToolbar() : null, props.loading ? _createVNode$1t(Loading, {
...
const {ref: ref$H,watch: watch$y,computed: computed$H,defineComponent: defineComponent$1q,mergeProps:_mergeProps$r,createVNode:_createVNode$1s} = await importShared('vue');
...
var stdin_default$1u = defineComponent$1q({
  ...
  setup(props, {
    ...
    watch$y(() => props.modelValue, (newCode) => {
      if (newCode) {
    ...
    return () => _createVNode$1s(Picker, _mergeProps$r({
      "ref": picker,
...
const {defineComponent: defineComponent$1p,createVNode:_createVNode$1r} = await importShared('vue');
  ...
  setup(props, {
    ...
    const renderTitle = () => {
      ...
      if (slots.title || isDef(props.title)) {
        ...
        }, [titleSlot || _createVNode$1r("span", null, [props.title]), renderLabel()]);
      }
    };
    const renderValue = () => {
...
const {defineComponent: defineComponent$1o,createVNode:_createVNode$1q} = await importShared('vue');
...
const {ref: ref$G,watch: watch$x,provide,computed: computed$G,nextTick: nextTick$h,reactive: reactive$b,onMounted: onMounted$d,defineComponent: defineComponent$1n,createVNode:_createVNode$1p,mergeProps:_mergeProps$q,createTextVNode:_createTextVNode$1} = await importShared('vue');
...
var stdin_default$1r = defineComponent$1n({
  ...
  setup(props, {
    ...
    const formValue = computed$G(() => {
      if (customValue.value && slots.input) {
        return customValue.value();
      }
      return props.modelValue;
    });
    const showRequiredMark = computed$G(() => {
      var _a;
    ...
    const renderInput = () => {
      ...
      if (props.type === "textarea") {
        return _createVNode$1p("textarea", _mergeProps$q(inputAttrs, {
          "inputmode": props.inputmode
        }), null);
      }
      return _createVNode$1p("input", _mergeProps$q(mapInputType(props.type, props.inputmode), inputAttrs), null);
    };
    const renderLeftIcon = () => {
      ...
      if (props.leftIcon || leftIconSlot) {
        ...
        }, [leftIconSlot ? leftIconSlot() : _createVNode$1p(Icon, {
          "name": props.leftIcon,
          "classPrefix": props.iconPrefix
        }, null)]);
      }
    ...
    const renderRightIcon = () => {
      ...
      if (props.rightIcon || rightIconSlot) {
        ...
        }, [rightIconSlot ? rightIconSlot() : _createVNode$1p(Icon, {
    ...
    const renderWordLimit = () => {
      if (props.showWordLimit && props.maxlength) {
        ...
        }, [_createVNode$1p("span", {
          "class": bem$1g("word-num")
        }, [count]), _createTextVNode$1("/"), props.maxlength]);
      }
    };
    const renderMessage = () => {
    ...
    const renderFieldBody = () => [_createVNode$1p("div", {
      "class": bem$1g("body")
    }, [renderInput(), showClear.value && _createVNode$1p(Icon, {
      "ref": clearIconRef,
      "name": props.clearIcon,
      "class": bem$1g("clear")
    }, null), renderRightIcon(), slots.button && _createVNode$1p("div", {
      "class": bem$1g("button")
...
const {watch: watch$w,onMounted: onMounted$c,onUnmounted: onUnmounted$1,defineComponent: defineComponent$1m,createVNode:_createVNode$1o,mergeProps:_mergeProps$p} = await importShared('vue');
...
var stdin_default$1q = defineComponent$1m({
  ...
  setup(props, {
    ...
    const renderIcon = () => {
      ...
      if (type === "loading") {
        return _createVNode$1o(Loading, {
    ...
    const renderMessage = () => {
      ...
      if (slots.message) {
        return _createVNode$1o("div", {
          "class": bem$1f("text")
        }, [slots.message()]);
      }
      if (isDef(message) && message !== "") {
        return type === "html" ? _createVNode$1o("div", {
          "key": 0,
          "class": bem$1f("text"),
          "innerHTML": String(message)
        }, null) : _createVNode$1o("div", {
          "class": bem$1f("text")
        }, [message]);
      }
    };
    watch$w(() => [props.show, props.forbidClick], toggleClickable);
    watch$w(() => [props.show, props.type, props.message, props.duration], () => {
      clearTimer();
    ...
    return () => _createVNode$1o(Popup, _mergeProps$p({
      "class": [bem$1f([props.position, props.wordBreak === "normal" ? "break-normal" : props.wordBreak, {
...
const {ref: ref$F,watch: watch$v,getCurrentInstance: getCurrentInstance$2,mergeProps:_mergeProps$o,createVNode:_createVNode$1n} = await importShared('vue');
  ...
  const {
    ...
    setup() {
      ...
      const render = () => {
        ...
        return _createVNode$1n(stdin_default$1q, _mergeProps$o(state, attrs), null);
      };
      watch$v(message, (val) => {
        state.message = val;
      });
...
const {defineComponent: defineComponent$1l,createVNode:_createVNode$1m} = await importShared('vue');
const [name$1j, bem$1e] = createNamespace("switch");
const switchProps = {
  size: numericProp,
  loading: Boolean,
  disabled: Boolean,
...
var stdin_default$1p = defineComponent$1l({
  name: name$1j,
  props: switchProps,
  ...
  setup(props, {
    ...
    const renderLoading = () => {
      if (props.loading) {
        ...
        return _createVNode$1m(Loading, {
...
const {ref: ref$E,defineComponent: defineComponent$1k,createVNode:_createVNode$1l,Fragment:_Fragment$4} = await importShared('vue');
const [name$1i, bem$1d] = createNamespace("address-edit-detail");
const t$j = createNamespace("address-edit")[2];
var stdin_default$1o = defineComponent$1k({
  name: name$1i,
  props: {
    show: Boolean,
    rows: numericProp,
  ...
  setup(props, {
    ...
    const renderSearchResult = () => {
      ...
      return searchResult.map((express) => _createVNode$1l(Cell, {
        "clickable": true,
    ...
    return () => {
      if (props.show) {
        return _createVNode$1l(_Fragment$4, null, [_createVNode$1l(Field, {
          "autosize": true,
          "clearable": true,
          "ref": field,
          "class": bem$1d(),
...
const {ref: ref$D,watch: watch$u,computed: computed$F,nextTick: nextTick$g,reactive: reactive$a,defineComponent: defineComponent$1j,createVNode:_createVNode$1k,vShow:_vShow$8,withDirectives:_withDirectives$9} = await importShared('vue');
const [name$1h, bem$1c, t$i] = createNamespace("address-edit");
const DEFAULT_DATA = {
  name: "",
  tel: "",
  city: "",
...
var stdin_default$1n = defineComponent$1j({
  name: name$1h,
  ...
  setup(props, {
    ...
    const showAreaPopup = ref$D(false);
    const detailFocused = ref$D(false);
    const areaListLoaded = computed$F(() => isObject(props.areaList) && Object.keys(props.areaList).length);
    const areaText = computed$F(() => {
      const {
        province,
        city,
        county,
    ...
    const hideBottomFields = computed$F(() => {
      var _a;
    ...
    watch$u(() => props.addressInfo, (value) => {
      ...
      return _createVNode$1k(Form, {
        ...
        default: () => {
          ...
          return [_createVNode$1k("div", {
            ...
            "placeholder": t$i("tel"),
            "onFocus": () => onFocus("tel")
          }, null), _withDirectives$9(_createVNode$1k(Field, {
            "readonly": true,
            "label": t$i("area"),
            "is-link": !disableArea,
          ...
          }, null), [[_vShow$8, props.showArea]]), _createVNode$1k(stdin_default$1o, {
          ...
          }, null), (_a = slots.default) == null ? void 0 : _a.call(slots)]), renderSetDefaultCell(), _withDirectives$9(_createVNode$1k("div", {
            "class": bem$1c("buttons")
          }, [_createVNode$1k(Button, {
            "block": true,
            "round": true,
            "type": "primary",
            ...
            "nativeType": "submit"
          }, null), props.showDelete && _createVNode$1k(Button, {
            "block": true,
            "round": true,
            "class": bem$1c("button"),
            ...
            "onClick": onDelete
          }, null)]), [[_vShow$8, !hideBottomFields.value]]), _createVNode$1k(Popup, {
...
const {watch: watch$t,defineComponent: defineComponent$1i,createVNode:_createVNode$1j} = await importShared('vue');
const [name$1g, bem$1b] = createNamespace("radio-group");
...
var stdin_default$1m = defineComponent$1i({
  name: name$1g,
  ...
  setup(props, {
    ...
    watch$t(() => props.modelValue, (value) => emit("change", value));
    linkChildren({
      props,
      updateValue
    });
...
const {watch: watch$s,defineComponent: defineComponent$1h,createVNode:_createVNode$1i} = await importShared('vue');
const [name$1f, bem$1a] = createNamespace("checkbox-group");
...
var stdin_default$1l = defineComponent$1h({
  name: name$1f,
  ...
  setup(props, {
    ...
    watch$s(() => props.modelValue, (value) => emit("change", value));
    useExpose({
      toggleAll
    });
    useCustomFieldValue(() => props.modelValue);
...
const {Transition: Transition$1,defineComponent: defineComponent$1g,createVNode:_createVNode$1h} = await importShared('vue');
const [name$1e, bem$19] = createNamespace("tag");
const tagProps = {
  size: String,
  mark: Boolean,
  show: truthProp,
...
var stdin_default$1k = defineComponent$1g({
  name: name$1e,
  props: tagProps,
  emits: ["close"],
  setup(props, {
    ...
    const renderTag = () => {
      ...
      const CloseIcon = closeable && _createVNode$1h(Icon, {
        "name": "cross",
        "class": [bem$19("close"), HAPTICS_FEEDBACK],
        "onClick": onClose
      }, null);
      return _createVNode$1h("span", {
        "style": getStyle(),
        "class": bem$19([classes, type])
      }, [(_a = slots.default) == null ? void 0 : _a.call(slots), CloseIcon]);
    };
    return () => _createVNode$1h(Transition$1, {
...
const {ref: ref$C,computed: computed$E,defineComponent: defineComponent$1f,createVNode:_createVNode$1g} = await importShared('vue');
const checkerProps = {
  name: unknownProp,
  disabled: Boolean,
  iconSize: numericProp,
...
var stdin_default$1j = defineComponent$1f({
  ...
  setup(props, {
    ...
    const direction = computed$E(() => getParentProp("direction"));
    const iconStyle = computed$E(() => {
    ...
    const renderIcon = () => {
      ...
      return _createVNode$1g("div", {
        ...
        checked,
        disabled: disabled.value
      }) : shape.value !== "dot" ? _createVNode$1g(Icon, {
        "name": indeterminate ? "minus" : "success",
        "style": iconStyle.value
      }, null) : _createVNode$1g("div", {
...
const {defineComponent: defineComponent$1e,mergeProps:_mergeProps$n,createVNode:_createVNode$1f} = await importShared('vue');
const radioProps = extend({}, checkerProps, {
  shape: String
});
const [name$1d, bem$18] = createNamespace("radio");
var stdin_default$1i = defineComponent$1e({
  name: name$1d,
  props: radioProps,
  ...
  setup(props, {
    ...
    return () => _createVNode$1f(stdin_default$1j, _mergeProps$n({
      "bem": bem$18,
      "role": "radio",
      "parent": parent,
      "checked": checked(),
...
const {watch: watch$r,computed: computed$D,defineComponent: defineComponent$1d,mergeProps:_mergeProps$m,createVNode:_createVNode$1e} = await importShared('vue');
const [name$1c, bem$17] = createNamespace("checkbox");
...
var stdin_default$1h = defineComponent$1d({
  name: name$1c,
  props: checkboxProps,
  emits: ["change", "update:modelValue"],
  setup(props, {
    ...
    watch$r(() => props.modelValue, (value) => {
    ...
    useCustomFieldValue(() => props.modelValue);
    return () => _createVNode$1e(stdin_default$1j, _mergeProps$m({
      "bem": bem$17,
      "role": "checkbox",
      "parent": parent,
...
const {defineComponent: defineComponent$1c,createVNode:_createVNode$1d} = await importShared('vue');
const [name$1b, bem$16] = createNamespace("address-item");
var stdin_default$1g = defineComponent$1c({
  name: name$1b,
  props: {
  ...
  setup(props, {
    ...
    const renderRightIcon = () => _createVNode$1d(Icon, {
      "name": props.rightIcon,
      "class": bem$16("edit"),
      "onClick": (event) => {
        event.stopPropagation();
    ...
    const renderContent = () => {
      ...
      const Info = [_createVNode$1d("div", {
        "class": bem$16("name")
      }, [`${address.name} ${address.tel}`, renderTag()]), _createVNode$1d("div", {
        "class": bem$16("address")
      }, [address.address])];
      if (switchable && !disabled) {
        if (singleChoice) {
          return _createVNode$1d(Radio, {
            "name": address.id,
            "iconSize": 18
          }, {
            default: () => [Info]
          ...
          return _createVNode$1d(Checkbox, {
            "name": address.id,
            "iconSize": 18
          }, {
            default: () => [Info]
    ...
    return () => {
      ...
      return _createVNode$1d("div", {
        ...
        "onClick": onClick
      }, [_createVNode$1d(Cell, {
        "border": false,
        "titleClass": bem$16("title")
      }, {
        title: renderContent,
...
const {defineComponent: defineComponent$1b,computed: computed$C,createVNode:_createVNode$1c} = await importShared('vue');
const [name$1a, bem$15, t$h] = createNamespace("address-list");
...
var stdin_default$1f = defineComponent$1b({
  name: name$1a,
  ...
  setup(props, {
    ...
    const singleChoice = computed$C(() => !Array.isArray(props.modelValue));
    const renderItem = (item, index, disabled) => {
      ...
      return _createVNode$1c(stdin_default$1g, {
        "key": item.id,
        "address": item,
        "disabled": disabled,
    ...
    const renderBottom = () => props.showAddButton ? _createVNode$1c("div", {
      "class": [bem$15("bottom"), "van-safe-area-bottom"]
    }, [_createVNode$1c(Button, {
      "round": true,
      "block": true,
      "type": "primary",
    ...
    return () => {
      ...
      const DisabledText = props.disabledText && _createVNode$1c("div", {
        "class": bem$15("disabled-text")
      }, [props.disabledText]);
      return _createVNode$1c("div", {
        "class": bem$15()
      }, [(_a = slots.top) == null ? void 0 : _a.call(slots), !singleChoice.value && Array.isArray(props.modelValue) ? _createVNode$1c(CheckboxGroup, {
        "modelValue": props.modelValue
      }, {
        default: () => [List]
      }) : _createVNode$1c(RadioGroup, {
        "modelValue": props.modelValue
      }, {
        default: () => [List]
...
const {ref: ref$B,watch: watch$q,computed: computed$B,Teleport: Teleport$4,nextTick: nextTick$f,onMounted: onMounted$b,defineComponent: defineComponent$1a,onDeactivated: onDeactivated$1,onActivated: onActivated$2,createVNode:_createVNode$1b,mergeProps:_mergeProps$l} = await importShared('vue');
const [name$19, bem$14] = createNamespace("back-top");
const backTopProps = {
  right: numericProp,
  bottom: numericProp,
  zIndex: numericProp,
...
var stdin_default$1e = defineComponent$1a({
  name: name$19,
  inheritAttrs: false,
  props: backTopProps,
  emits: ["click"],
  setup(props, {
    ...
    const show = ref$B(false);
    const root = ref$B();
    const scrollParent = ref$B();
    const style = computed$B(() => extend(getZIndexStyle(props.zIndex), {
    ...
    watch$q(() => props.target, updateTarget);
    return () => {
      const Content = _createVNode$1b("div", _mergeProps$l({
        ...
        "style": style.value,
        "onClick": onClick
      }, attrs), [slots.default ? slots.default() : _createVNode$1b(Icon, {
        "name": "back-top",
        "class": bem$14("icon")
      }, null)]);
      if (props.teleport) {
        return [_createVNode$1b("div", {
          "ref": root,
          "class": bem$14("placeholder")
        }, null), _createVNode$1b(Teleport$4, {
          "to": props.teleport
        }, {
          default: () => [Content]
        })];
...
const {defineComponent: defineComponent$19,onMounted: onMounted$a,ref: ref$A,nextTick: nextTick$e,watch: watch$p,createVNode:_createVNode$1a} = await importShared('vue');
const barrageProps = {
...
const [name$18, bem$13] = createNamespace("barrage");
var stdin_default$1d = defineComponent$19({
  name: name$18,
  props: barrageProps,
  emits: ["update:modelValue"],
  setup(props, {
    ...
    const barrageWrapper = ref$A();
    const className = bem$13("item");
    const total = ref$A(0);
    const barrageItems = [];
    ...
    const isInitBarrage = ref$A(true);
    const isPlay = ref$A(props.autoPlay);
    ...
    watch$p(() => props.modelValue.slice(), (newValue, oldValue) => updateBarrages(newValue != null ? newValue : [], oldValue != null ? oldValue : []), {
      deep: true
    });
    const rootStyle = ref$A({});
    onMounted$a(() => __async(null, null, function* () {
      var _a;
...
const Barrage = withInstall(stdin_default$1d);

const [name$17, bem$12, t$g] = createNamespace("calendar");
...
const {computed: computed$A,defineComponent: defineComponent$18,createVNode:_createVNode$19} = await importShared('vue');
const [name$16] = createNamespace("calendar-day");
var stdin_default$1c = defineComponent$18({
  name: name$16,
  props: {
  ...
  setup(props, {
    ...
    return () => {
      ...
      return _createVNode$19("div", {
        "role": "gridcell",
        "style": style.value,
        "class": [bem$12("day", type), className],
...
const {ref: ref$z,computed: computed$z,defineComponent: defineComponent$17,createVNode:_createVNode$18} = await importShared('vue');
...
var stdin_default$1b = defineComponent$17({
  name: name$15,
  ...
  setup(props, {
    ...
    const daysRef = ref$z();
    const monthRef = ref$z();
    const height = useHeight(monthRef);
    const title = computed$z(() => formatMonthTitle(props.date));
    const rowHeight = computed$z(() => addUnit(props.rowHeight));
    const offset = computed$z(() => {
    ...
    const totalDay = computed$z(() => getMonthEndDay(props.date.getFullYear(), props.date.getMonth() + 1));
    const shouldRender = computed$z(() => visible.value || !props.lazyRender);
    ...
    const renderTitle = () => {
      if (props.showMonthTitle) {
        return _createVNode$18("div", {
          "class": bem$12("month-title")
    ...
    const renderMark = () => {
      if (props.showMark && shouldRender.value) {
        return _createVNode$18("div", {
          "class": bem$12("month-mark")
        }, [props.date.getMonth() + 1]);
      }
    };
    const placeholders = computed$z(() => {
      const count = Math.ceil((totalDay.value + offset.value) / 7);
      return Array(count).fill({
        type: "placeholder"
      });
    });
    const days = computed$z(() => {
      const days2 = [];
    ...
    const disabledDays = computed$z(() => days.value.filter((day) => day.type === "disabled"));
    ...
    const renderDay = (item, index) => _createVNode$18(stdin_default$1c, {
      "item": item,
      "index": index,
      "color": props.color,
      "offset": offset.value,
    ...
    const renderDays = () => _createVNode$18("div", {
      "ref": daysRef,
      "role": "grid",
      "class": bem$12("days")
...
const {computed: computed$y,defineComponent: defineComponent$16,createVNode:_createVNode$17} = await importShared('vue');
const [name$14] = createNamespace("calendar-header");
var stdin_default$1a = defineComponent$16({
  name: name$14,
  props: {
    date: Date,
    minDate: Date,
  ...
  setup(props, {
    ...
    const prevMonthDisabled = computed$y(() => props.date && props.minDate && compareMonth(getPrevMonth(props.date), props.minDate) < 0);
    const prevYearDisabled = computed$y(() => props.date && props.minDate && compareMonth(getPrevYear(props.date), props.minDate) < 0);
    const nextMonthDisabled = computed$y(() => props.date && props.maxDate && compareMonth(getNextMonth(props.date), props.maxDate) > 0);
    const nextYearDisabled = computed$y(() => props.date && props.maxDate && compareMonth(getNextYear(props.date), props.maxDate) > 0);
    const renderTitle = () => {
      if (props.showTitle) {
        const text = props.title || t$g("title");
        const title = slots.title ? slots.title() : text;
        return _createVNode$17("div", {
          "class": bem$12("header-title")
        }, [title]);
      }
    };
    ...
    const renderAction = (isNext) => {
      ...
      const MonthAction = _createVNode$17("view", {
        "class": bem$12("header-action", {
          disabled: monthDisabled
        }),
        "onClick": monthDisabled ? void 0 : onMonthChange
      }, [monthSlot ? monthSlot({
        disabled: monthDisabled
      }) : _createVNode$17(Icon, {
        "class": {
          [HAPTICS_FEEDBACK]: !monthDisabled
        },
        "name": monthIconName
      }, null)]);
      const YearAction = showYearAction && _createVNode$17("view", {
        "class": bem$12("header-action", {
    ...
    const renderSubtitle = () => {
      if (props.showSubtitle) {
        ...
        return _createVNode$17("div", {
          "class": bem$12("header-subtitle", {
            "with-switch": canSwitch
          }),
          "onClick": onClickSubtitle
        }, [canSwitch ? [renderAction(), _createVNode$17("div", {
          "class": bem$12("header-subtitle-text")
    ...
    const renderWeekDays = () => {
      ...
      return _createVNode$17("div", {
        "class": bem$12("weekdays")
      }, [renderWeekDays2.map((text) => _createVNode$17("span", {
        "class": bem$12("weekday")
      }, [text]))]);
    };
    return () => _createVNode$17("div", {
      "class": bem$12("header")
...
const {ref: ref$y,watch: watch$o,computed: computed$x,defineComponent: defineComponent$15,mergeProps:_mergeProps$k,createVNode:_createVNode$16} = await importShared('vue');
const calendarProps = {
  show: Boolean,
...
var stdin_default$19 = defineComponent$15({
  name: name$17,
  props: calendarProps,
  ...
  setup(props, {
    ...
    const canSwitch = computed$x(() => props.switchMode !== "none");
    ...
    let bodyHeight;
    const bodyRef = ref$y();
    const currentDate = ref$y(getInitialDate());
    const currentPanelDate = ref$y(getInitialPanelDate());
    const currentMonthRef = ref$y();
    const [monthRefs, setMonthRefs] = useRefs();
    const dayOffset = computed$x(() => props.firstDayOfWeek ? +props.firstDayOfWeek % 7 : 0);
    const months = computed$x(() => {
      const months2 = [];
    ...
    const buttonDisabled = computed$x(() => {
    ...
    const disabledDays = computed$x(() => monthRefs.value.reduce((arr, ref2) => {
      var _a, _b;
    ...
    const renderMonth = (date, index) => {
      ...
      return _createVNode$16(stdin_default$1b, _mergeProps$k({
    ...
    const renderFooterButton = () => {
      ...
      if (props.showConfirm) {
        ...
        return _createVNode$16(Button, {
          "round": true,
          "block": true,
          "type": "primary",
          "color": props.color,
          "class": bem$12("confirm"),
          "disabled": disabled,
          "nativeType": "button",
          "onClick": onConfirm
        }, {
    ...
    const renderFooter = () => _createVNode$16("div", {
      "class": [bem$12("footer"), {
        "van-safe-area-bottom": props.safeAreaInsetBottom
      }]
    }, [renderFooterButton()]);
    const renderCalendar = () => {
      var _a, _b;
      return _createVNode$16("div", {
        "class": bem$12()
      }, [_createVNode$16(stdin_default$1a, {
      ...
      }, pick(slots, ["title", "subtitle", "prev-month", "prev-year", "next-month", "next-year"])), _createVNode$16("div", {
        "ref": bodyRef,
        "class": bem$12("body"),
    ...
    watch$o(() => props.show, init);
    watch$o(() => [props.type, props.minDate, props.maxDate, props.switchMode], () => reset(getInitialDate(currentDate.value)));
    watch$o(() => props.defaultDate, (value) => {
      reset(value);
    });
    useExpose({
      reset,
...
const {ref: ref$x,watch: watch$n,computed: computed$w,nextTick: nextTick$d,onMounted: onMounted$9,onBeforeUnmount: onBeforeUnmount$2,defineComponent: defineComponent$14,getCurrentInstance: getCurrentInstance$1,createVNode:_createVNode$15,resolveDirective:_resolveDirective,mergeProps:_mergeProps$j,withDirectives:_withDirectives$8} = await importShared('vue');
const [name$13, bem$11] = createNamespace("image");
const imageProps = {
  src: String,
  alt: String,
  fit: String,
...
var stdin_default$18 = defineComponent$14({
  name: name$13,
  props: imageProps,
  emits: ["load", "error"],
  setup(props, {
    ...
    const error = ref$x(false);
    const loading = ref$x(true);
    const imageRef = ref$x();
    const {
      $Lazyload
    } = getCurrentInstance$1().proxy;
    const style = computed$w(() => {
      const style2 = {
    ...
    const renderPlaceholder = () => {
      if (loading.value && props.showLoading) {
        ...
        }, [renderIcon(props.loadingIcon, bem$11("loading-icon"), slots.loading)]);
      }
      if (error.value && props.showError) {
        return _createVNode$15("div", {
          "class": bem$11("error")
        }, [renderIcon(props.errorIcon, bem$11("error-icon"), slots.error)]);
      }
    };
    const renderImage = () => {
      ...
      if (props.lazyLoad) {
        return _withDirectives$8(_createVNode$15("img", _mergeProps$j({
          "ref": imageRef
        }, attrs), null), [[_resolveDirective("lazy"), props.src]]);
      }
      return _createVNode$15("img", _mergeProps$j({
        "ref": imageRef,
        "src": props.src,
        "onLoad": onLoad,
        "onError": onError
...
const {defineComponent: defineComponent$13,createVNode:_createVNode$14,Fragment:_Fragment$3,createTextVNode:_createTextVNode} = await importShared('vue');
const [name$12, bem$10] = createNamespace("card");
const cardProps = {
  tag: String,
  num: numericProp,
  desc: String,
...
var stdin_default$17 = defineComponent$13({
  name: name$12,
  props: cardProps,
  emits: ["clickThumb"],
  setup(props, {
    ...
    const renderTitle = () => {
      ...
      if (props.title) {
        return _createVNode$14("div", {
          "class": [bem$10("title"), "van-multi-ellipsis--l2"]
        }, [props.title]);
      }
    };
    const renderThumbTag = () => {
      if (slots.tag || props.tag) {
        return _createVNode$14("div", {
          "class": bem$10("tag")
        }, [slots.tag ? slots.tag() : _createVNode$14(Tag, {
          "mark": true,
          "type": "primary"
        }, {
          default: () => [props.tag]
    ...
    const renderThumbImage = () => {
      ...
      return _createVNode$14(Image$1, {
        "src": props.thumb,
        "fit": "cover",
        "width": "100%",
        "height": "100%",
    ...
    const renderDesc = () => {
      ...
      if (props.desc) {
        return _createVNode$14("div", {
          "class": [bem$10("desc"), "van-ellipsis"]
        }, [props.desc]);
      }
    };
    const renderPriceText = () => {
      const priceArr = props.price.toString().split(".");
      return _createVNode$14("div", null, [_createVNode$14("span", {
        "class": bem$10("price-currency")
      }, [props.currency]), _createVNode$14("span", {
        "class": bem$10("price-integer")
      }, [priceArr[0]]), priceArr.length > 1 && _createVNode$14(_Fragment$3, null, [_createTextVNode("."), _createVNode$14("span", {
        "class": bem$10("price-decimal")
      }, [priceArr[1]])])]);
    };
    return () => {
      var _a, _b, _c;
      ...
      const Price = showPrice && _createVNode$14("div", {
        "class": bem$10("price")
      }, [slots.price ? slots.price() : renderPriceText()]);
      const OriginPrice = showOriginPrice && _createVNode$14("div", {
        "class": bem$10("origin-price")
      }, [slots["origin-price"] ? slots["origin-price"]() : `${props.currency} ${props.originPrice}`]);
      const Num = showNum && _createVNode$14("div", {
        "class": bem$10("num")
      }, [slots.num ? slots.num() : `x${props.num}`]);
      const Footer = slots.footer && _createVNode$14("div", {
        "class": bem$10("footer")
      }, [slots.footer()]);
      const Bottom = showBottom && _createVNode$14("div", {
        "class": bem$10("bottom")
      ...
      return _createVNode$14("div", {
        ...
        "class": bem$10("header")
      }, [renderThumb(), _createVNode$14("div", {
        "class": bem$10("content", {
          centered: props.centered
        })
      }, [_createVNode$14("div", null, [renderTitle(), renderDesc(), (_c = slots.tags) == null ? void 0 : _c.call(slots)]), Bottom])]), Footer]);
    };
  }
});
...
const {ref: ref$w,watch: watch$m,nextTick: nextTick$c,defineComponent: defineComponent$12,createVNode:_createVNode$13} = await importShared('vue');
const [name$11, bem$$, t$f] = createNamespace("cascader");
const cascaderProps = {
  title: String,
  options: makeArrayProp(),
  closeable: truthProp,
...
var stdin_default$16 = defineComponent$12({
  name: name$11,
  props: cascaderProps,
  ...
  setup(props, {
    ...
    const renderHeader = () => props.showHeader ? _createVNode$13("div", {
      "class": bem$$("header")
    }, [_createVNode$13("h2", {
      "class": bem$$("title")
    }, [slots.title ? slots.title() : props.title]), props.closeable ? _createVNode$13(Icon, {
      "name": props.closeIcon,
    ...
    const renderOption = (option, selectedOption, tabIndex) => {
      ...
      const Text = slots.option ? slots.option({
        option,
        selected
      }) : _createVNode$13("span", null, [option[textKey]]);
      return _createVNode$13("li", {
      ...
      }, [Text, selected ? _createVNode$13(Icon, {
        "name": "success",
        "class": bem$$("selected-icon")
      }, null) : null]);
    };
    const renderOptions = (options, selectedOption, tabIndex) => _createVNode$13("ul", {
      "role": "menu",
      "class": bem$$("options")
    ...
    const renderTabs = () => _createVNode$13(Tabs, {
      "active": activeTab.value,
      "onUpdate:active": ($event) => activeTab.value = $event,
      "shrink": true,
      "animated": true,
    ...
    updateTabs();
    watch$m(activeTab, (value) => {
      const el = selectedElementRefs.value[value];
      if (el) scrollIntoView(el);
    });
    watch$m(() => props.options, updateTabs, {
      deep: true
    });
    watch$m(() => props.modelValue, (value) => {
      if (value !== void 0) {
...
const {defineComponent: defineComponent$11,mergeProps:_mergeProps$i,createVNode:_createVNode$12,Fragment:_Fragment$2} = await importShared('vue');
const [name$10, bem$_] = createNamespace("cell-group");
const cellGroupProps = {
  title: String,
  inset: Boolean,
  border: truthProp
};
var stdin_default$15 = defineComponent$11({
  name: name$10,
  inheritAttrs: false,
  ...
  setup(props, {
    ...
    const renderGroup = () => {
      var _a;
      return _createVNode$12("div", _mergeProps$i({
        "class": [bem$_({
          inset: props.inset
        }), {
    ...
    const renderTitle = () => _createVNode$12("div", {
      "class": bem$_("title", {
        inset: props.inset
      })
    }, [slots.title ? slots.title() : props.title]);
    return () => {
      if (props.title || slots.title) {
        return _createVNode$12(_Fragment$2, null, [renderTitle(), renderGroup()]);
      }
      return renderGroup();
    };
  }
...
const {watch: watch$l,computed: computed$v,defineComponent: defineComponent$10,createVNode:_createVNode$11} = await importShared('vue');
const [name$$, bem$Z] = createNamespace("circle");
let uid = 0;
...
var stdin_default$14 = defineComponent$10({
  name: name$$,
  props: circleProps,
  ...
  setup(props, {
    ...
    const viewBoxSize = computed$v(() => +props.strokeWidth + 1e3);
    const path = computed$v(() => getPath(props.clockwise, viewBoxSize.value));
    const svgStyle = computed$v(() => {
    ...
    const renderGradient = () => {
      ...
      const Stops = Object.keys(color).sort((a, b) => parseFloat(a) - parseFloat(b)).map((key, index) => _createVNode$11("stop", {
        "key": index,
        "offset": key,
        "stop-color": color[key]
      }, null));
      return _createVNode$11("defs", null, [_createVNode$11("linearGradient", {
        "id": id,
        "x1": "100%",
        "y1": "0%",
        "x2": "0%",
...
const {computed: computed$u,defineComponent: defineComponent$$,createVNode:_createVNode$10} = await importShared('vue');
const [name$_, bem$Y] = createNamespace("row");
...
var stdin_default$13 = defineComponent$$({
  ...
  setup(props, {
    ...
    const verticalSpaces = computed$u(() => {
      const {
        gutter
      } = props;
      const spaces2 = [];
...
const {computed: computed$t,defineComponent: defineComponent$_,createVNode:_createVNode$$} = await importShared('vue');
const [name$Z, bem$X] = createNamespace("col");
const colProps = {
  tag: makeStringProp("div"),
  span: makeNumericProp(0),
  offset: numericProp
};
var stdin_default$12 = defineComponent$_({
  name: name$Z,
  props: colProps,
  setup(props, {
    slots
...
const {defineComponent: defineComponent$Z,createVNode:_createVNode$_} = await importShared('vue');
const [name$Y, bem$W] = createNamespace("collapse");
...
var stdin_default$11 = defineComponent$Z({
  name: name$Y,
  props: collapseProps,
  emits: ["change", "update:modelValue"],
  setup(props, {
...
const {ref: ref$v,watch: watch$k,computed: computed$s,nextTick: nextTick$b,defineComponent: defineComponent$Y,mergeProps:_mergeProps$h,createVNode:_createVNode$Z,vShow:_vShow$7,withDirectives:_withDirectives$7} = await importShared('vue');
const [name$X, bem$V] = createNamespace("collapse-item");
...
var stdin_default$10 = defineComponent$Y({
  name: name$X,
  props: collapseItemProps,
  setup(props, {
    slots
  }) {
    const wrapperRef = ref$v();
    const contentRef = ref$v();
    const {
      parent,
      index
    ...
    const name2 = computed$s(() => {
      var _a;
      return (_a = props.name) != null ? _a : index.value;
    });
    const expanded = computed$s(() => parent.isExpanded(name2.value));
    const show = ref$v(expanded.value);
    ...
    watch$k(expanded, (value, oldValue) => {
      if (oldValue === null) {
        return;
      }
      if (value) {
      ...
      const tick = value ? nextTick$b : raf;
      tick(() => {
    ...
    const renderTitle = () => {
      ...
      return _createVNode$Z(Cell, _mergeProps$h({
        "role": "button",
        "class": bem$V("title", {
          disabled,
    ...
    const renderContent = lazyRender(() => {
      var _a;
      return _withDirectives$7(_createVNode$Z("div", {
        "ref": wrapperRef,
        "class": bem$V("wrapper"),
        ...
        "ref": contentRef,
        "class": bem$V("content")
      }, [(_a = slots.default) == null ? void 0 : _a.call(slots)])]), [[_vShow$7, show.value]]);
    });
    useExpose({
      toggle,
      expanded,
...
const {defineComponent: defineComponent$X,createVNode:_createVNode$Y} = await importShared('vue');
const [name$W, bem$U, t$e] = createNamespace("contact-card");
...
var stdin_default$$ = defineComponent$X({
  name: name$W,
  ...
  setup(props, {
    ...
    const renderContent = () => {
      ...
      return [_createVNode$Y("div", null, [`${t$e("name")}\uFF1A${props.name}`]), _createVNode$Y("div", null, [`${t$e("tel")}\uFF1A${props.tel}`])];
    };
    return () => _createVNode$Y(Cell, {
      "center": true,
...
const {watch: watch$j,reactive: reactive$9,defineComponent: defineComponent$W,createVNode:_createVNode$X} = await importShared('vue');
const [name$V, bem$T, t$d] = createNamespace("contact-edit");
...
var stdin_default$_ = defineComponent$W({
  name: name$V,
  ...
  setup(props, {
    ...
    const contact = reactive$9(extend({}, DEFAULT_CONTACT, props.contactInfo));
    const onSave = () => {
      if (!props.isSaving) {
        emit("save", contact);
      }
    ...
    const renderButtons = () => _createVNode$X("div", {
      "class": bem$T("buttons")
    }, [_createVNode$X(Button, {
      "block": true,
      "round": true,
      "type": "primary",
      "text": t$d("save"),
      ...
      "loading": props.isSaving,
      "nativeType": "submit"
    }, null), props.isEdit && _createVNode$X(Button, {
      "block": true,
      "round": true,
      "text": t$d("delete"),
      "class": bem$T("button"),
    ...
    const renderSwitch = () => _createVNode$X(Switch, {
    ...
    watch$j(() => props.contactInfo, (value) => extend(contact, DEFAULT_CONTACT, value));
    return () => _createVNode$X(Form, {
      "class": bem$T(),
      "onSubmit": onSave
    }, {
      default: () => [_createVNode$X("div", {
        "class": bem$T("fields")
      }, [_createVNode$X(Field, {
...
const {defineComponent: defineComponent$V,createVNode:_createVNode$W} = await importShared('vue');
const [name$U, bem$S, t$c] = createNamespace("contact-list");
...
var stdin_default$Z = defineComponent$V({
  name: name$U,
  ...
  setup(props, {
    ...
    const renderItem = (item, index) => {
      ...
      const renderRightIcon = () => _createVNode$W(Radio, {
        "class": bem$S("radio"),
        "name": item.id,
        "iconSize": 18
      }, null);
      const renderEditIcon = () => _createVNode$W(Icon, {
        "name": "edit",
        "class": bem$S("edit"),
        "onClick": (event) => {
          event.stopPropagation();
    ...
    return () => _createVNode$W("div", {
      "class": bem$S()
    }, [_createVNode$W(RadioGroup, {
      "modelValue": props.modelValue,
      "class": bem$S("group")
    }, {
...
const {watch: watch$i,computed: computed$r,defineComponent: defineComponent$U,createVNode:_createVNode$V} = await importShared('vue');
const [name$T, bem$R] = createNamespace("count-down");
...
var stdin_default$Y = defineComponent$U({
  name: name$T,
  ...
  setup(props, {
    ...
    const timeText = computed$r(() => parseFormat(props.format, current.value));
    const resetTime = () => {
      reset(+props.time);
      if (props.autoStart) {
        start();
...
const {computed: computed$q,defineComponent: defineComponent$T,createVNode:_createVNode$U} = await importShared('vue');
const [name$S, bem$Q, t$b] = createNamespace("coupon");
var stdin_default$X = defineComponent$T({
  name: name$S,
  props: {
    chosen: Boolean,
  ...
  setup(props) {
    ...
    const faceAmount = computed$q(() => {
      const {
        coupon,
        currency
      } = props;
      if (coupon.valueDesc) {
        return [coupon.valueDesc, _createVNode$U("span", null, [coupon.unitDesc || ""])];
      }
      if (coupon.denominations) {
        const denominations = formatAmount(coupon.denominations);
        return [_createVNode$U("span", null, [currency]), ` ${denominations}`];
      }
      if (coupon.discount) {
    ...
    const conditionMessage = computed$q(() => {
    ...
    return () => {
      ...
      return _createVNode$U("div", {
        ...
        "class": bem$Q("amount")
      }, [faceAmount.value]), _createVNode$U("p", {
        "class": bem$Q("condition")
      }, [coupon.condition || conditionMessage.value])]), _createVNode$U("div", {
        "class": bem$Q("body")
      }, [_createVNode$U("p", {
        "class": bem$Q("name")
      }, [coupon.name]), _createVNode$U("p", {
        "class": bem$Q("valid")
      }, [validPeriod.value]), !disabled && _createVNode$U(Checkbox, {
        "class": bem$Q("corner"),
        "modelValue": chosen
      }, null)])]), description && _createVNode$U("p", {
...
const {defineComponent: defineComponent$S,createVNode:_createVNode$T} = await importShared('vue');
const [name$R, bem$P, t$a] = createNamespace("coupon-cell");
...
const {defineComponent: defineComponent$R,createVNode:_createVNode$S} = await importShared('vue');
const [name$Q, bem$O] = createNamespace("empty");
const emptyProps = {
  image: makeStringProp("default"),
  imageSize: [Number, String, Array],
  description: String
};
var stdin_default$V = defineComponent$R({
  name: name$Q,
  props: emptyProps,
  setup(props, {
    slots
    ...
    const renderStop = (color, offset, opacity) => _createVNode$S("stop", {
      "stop-color": color,
      "offset": `${offset}%`,
      "stop-opacity": opacity
    }, null);
    const renderStops = (fromColor, toColor) => [renderStop(fromColor, 0), renderStop(toColor, 100)];
    const renderShadow = (id) => [_createVNode$S("defs", null, [_createVNode$S("radialGradient", {
      "id": getId(id),
      "cx": "50%",
      "cy": "54%",
      "fx": "50%",
      ...
      "data-allow-mismatch": "attribute"
    }, [renderStop("#EBEDF0", 0), renderStop("#F2F3F5", 100, 0.3)])]), _createVNode$S("ellipse", {
      "fill": getUrlById(id),
      "opacity": ".8",
      "cx": "80",
      "cy": "140",
    ...
    const renderBuilding = () => [_createVNode$S("defs", null, [_createVNode$S("linearGradient", {
      "id": getId("a"),
      "x1": "64%",
      "y1": "100%",
      "x2": "64%",
      "data-allow-mismatch": "attribute"
    }, [renderStop("#FFF", 0, 0.5), renderStop("#F2F3F5", 100)])]), _createVNode$S("g", {
      "opacity": ".8",
      "data-allow-mismatch": "children"
    }, [_createVNode$S("path", {
      "d": "M36 131V53H16v20H2v58h34z",
      "fill": getUrlById("a")
    }, null), _createVNode$S("path", {
      "d": "M123 15h22v14h9v77h-31V15z",
      "fill": getUrlById("a")
    }, null)])];
    const renderCloud = () => [_createVNode$S("defs", null, [_createVNode$S("linearGradient", {
      "id": getId("b"),
      "x1": "64%",
      "y1": "97%",
      "x2": "64%",
      "y2": "0%",
      "data-allow-mismatch": "attribute"
    }, [renderStop("#F2F3F5", 0, 0.3), renderStop("#F2F3F5", 100)])]), _createVNode$S("g", {
      "opacity": ".8",
      "data-allow-mismatch": "children"
    }, [_createVNode$S("path", {
    ...
    const renderNetwork = () => _createVNode$S("svg", {
      "viewBox": "0 0 160 160"
    }, [_createVNode$S("defs", {
      "data-allow-mismatch": "children"
    }, [_createVNode$S("linearGradient", {
      "id": getId(1),
      "x1": "64%",
      "y1": "100%",
      "x2": "64%"
    }, [renderStop("#FFF", 0, 0.5), renderStop("#F2F3F5", 100)]), _createVNode$S("linearGradient", {
      "id": getId(2),
      "x1": "50%",
      "x2": "50%",
      "y2": "84%"
    }, [renderStop("#EBEDF0", 0), renderStop("#DCDEE0", 100, 0)]), _createVNode$S("linearGradient", {
      "id": getId(3),
      "x1": "100%",
      "x2": "100%",
      "y2": "100%"
    }, [renderStops("#EAEDF0", "#DCDEE0")]), _createVNode$S("radialGradient", {
      "id": getId(4),
      "cx": "50%",
      "cy": "0%",
      "fx": "50%",
    ...
    }, [renderStop("#EBEDF0", 0), renderStop("#FFF", 100, 0)])]), _createVNode$S("g", {
      "fill": "none"
    }, [renderBuilding(), _createVNode$S("path", {
      "fill": getUrlById(4),
      "d": "M0 139h160v21H0z",
      "data-allow-mismatch": "attribute"
    }, null), _createVNode$S("path", {
    ...
    const renderMaterial = () => _createVNode$S("svg", {
      "viewBox": "0 0 160 160"
    }, [_createVNode$S("defs", {
      "data-allow-mismatch": "children"
    }, [_createVNode$S("linearGradient", {
      ...
      "y2": "100%",
      "id": getId(5)
    }, [renderStops("#F2F3F5", "#DCDEE0")]), _createVNode$S("linearGradient", {
      "x1": "95%",
      "y1": "48%",
      "x2": "5.5%",
      "y2": "51%",
      "id": getId(6)
    }, [renderStops("#EAEDF1", "#DCDEE0")]), _createVNode$S("linearGradient", {
      "y1": "45%",
      "x2": "100%",
      "y2": "54%",
      "id": getId(7)
    }, [renderStops("#EAEDF1", "#DCDEE0")])]), renderBuilding(), renderCloud(), _createVNode$S("g", {
    ...
    const renderError = () => _createVNode$S("svg", {
      "viewBox": "0 0 160 160"
    }, [_createVNode$S("defs", null, [_createVNode$S("linearGradient", {
      "x1": "50%",
      "x2": "50%",
      "y2": "100%",
      "id": getId(8),
      "data-allow-mismatch": "attribute"
    }, [renderStops("#EAEDF1", "#DCDEE0")])]), renderBuilding(), renderCloud(), renderShadow("c"), _createVNode$S("path", {
      "d": "m59 60 21 21 21-21h3l9 9v3L92 93l21 21v3l-9 9h-3l-21-21-21 21h-3l-9-9v-3l21-21-21-21v-3l9-9h3Z",
      "fill": getUrlById(8),
      "data-allow-mismatch": "attribute"
    }, null)]);
    const renderSearch = () => _createVNode$S("svg", {
      "viewBox": "0 0 160 160"
    }, [_createVNode$S("defs", {
      "data-allow-mismatch": "children"
    }, [_createVNode$S("linearGradient", {
      ...
      "x2": "50%",
      "id": getId(9)
    }, [renderStops("#EEE", "#D8D8D8")]), _createVNode$S("linearGradient", {
      "x1": "100%",
      "y1": "50%",
      "y2": "50%",
      "id": getId(10)
      ...
      "y2": "100%",
      "id": getId(12)
    }, [renderStops("#FFF", "#F7F8FA")])]), renderBuilding(), renderCloud(), renderShadow("d"), _createVNode$S("g", {
    ...
    const renderImage = () => {
      ...
      return ((_a = PRESET_IMAGES[props.image]) == null ? void 0 : _a.call(PRESET_IMAGES)) || _createVNode$S("img", {
        "src": props.image
      }, null);
    };
    return () => _createVNode$S("div", {
...
const {ref: ref$u,watch: watch$h,computed: computed$p,nextTick: nextTick$a,onMounted: onMounted$8,defineComponent: defineComponent$Q,createVNode:_createVNode$R,vShow:_vShow$6,withDirectives:_withDirectives$6} = await importShared('vue');
const [name$P, bem$N, t$9] = createNamespace("coupon-list");
...
var stdin_default$U = defineComponent$Q({
  name: name$P,
  ...
  setup(props, {
    ...
    const root = ref$u();
    const barRef = ref$u();
    const activeTab = ref$u(0);
    const listHeight = ref$u(0);
    const currentCode = ref$u(props.code);
    const buttonDisabled = computed$p(() => !props.exchangeButtonLoading && (props.exchangeButtonDisabled || !currentCode.value || currentCode.value.length < props.exchangeMinLength));
    ...
    const renderEmpty = () => _createVNode$R(Empty, {
      "image": props.emptyImage
    }, {
      default: () => [_createVNode$R("p", {
    ...
    const renderCouponTab = () => {
      ...
      return _createVNode$R(Tab, {
        ...
        default: () => {
          ...
          }, [coupons.map((coupon, index) => _createVNode$R(Coupon, {
            "key": coupon.id,
    ...
    const renderDisabledTab = () => {
      ...
      return _createVNode$R(Tab, {
        ...
        default: () => {
          ...
          }, [disabledCoupons.map((coupon) => _createVNode$R(Coupon, {
            "disabled": true,
            "key": coupon.id,
            "coupon": coupon,
            "currency": props.currency
    ...
    watch$h(() => props.code, (value) => {
      currentCode.value = value;
    });
    watch$h(windowHeight, updateListHeight);
    watch$h(currentCode, (value) => emit("update:code", value));
    watch$h(() => props.displayedCouponIndex, scrollToCoupon);
    onMounted$8(() => {
      updateListHeight();
    ...
    return () => _createVNode$R("div", {
      "ref": root,
      "class": bem$N()
    }, [renderExchangeBar(), _createVNode$R(Tabs, {
      "active": activeTab.value,
      "onUpdate:active": ($event) => activeTab.value = $event,
      "class": bem$N("tab")
    }, {
      ...
      "class": bem$N("bottom")
    }, [slots["list-button"] ? slots["list-button"]() : _withDirectives$6(_createVNode$R(Button, {
      "round": true,
      "block": true,
      "type": "primary",
      "class": bem$N("close"),
    ...
    }, null), [[_vShow$6, props.showCloseButton]])])]);
  }
});

const CouponList = withInstall(stdin_default$U);

const {ref: ref$t,watch: watch$g,computed: computed$o,defineComponent: defineComponent$P,mergeProps:_mergeProps$g,createVNode:_createVNode$Q} = await importShared('vue');
...
var stdin_default$T = defineComponent$P({
  name: name$O,
  ...
  setup(props, {
    ...
    const currentValues = ref$t(props.modelValue);
    const updatedByExternalSources = ref$t(false);
    const pickerRef = ref$t();
    const computedValues = computed$o(() => updatedByExternalSources.value ? props.modelValue : currentValues.value);
    ...
    const columns = computed$o(() => props.columnsType.map((type) => {
      switch (type) {
        case "year":
    ...
    watch$g(currentValues, (newValues) => {
      if (!isSameValue(newValues, props.modelValue)) {
        emit("update:modelValue", newValues);
      }
    });
    watch$g(() => props.modelValue, (newValues, oldValues) => {
    ...
    return () => _createVNode$Q(Picker, _mergeProps$g({
      "ref": pickerRef,
...
const {ref: ref$s,reactive: reactive$8,withKeys,defineComponent: defineComponent$O,createVNode:_createVNode$P,mergeProps:_mergeProps$f} = await importShared('vue');
const [name$N, bem$M, t$8] = createNamespace("dialog");
...
var stdin_default$S = defineComponent$O({
  name: name$N,
  props: dialogProps,
  ...
  setup(props, {
    ...
    const renderButtons = () => _createVNode$P("div", {
      "class": [BORDER_TOP, bem$M("footer")]
    }, [props.showCancelButton && _createVNode$P(Button, {
      "size": "large",
      ...
      "onClick": onCancel
    }, null), props.showConfirmButton && _createVNode$P(Button, {
      "size": "large",
    ...
    const renderRoundButtons = () => _createVNode$P(ActionBar, {
      "class": bem$M("footer")
    }, {
      default: () => [props.showCancelButton && _createVNode$P(ActionBarButton, {
        "type": "warning",
        "text": props.cancelButtonText || t$8("cancel"),
        "class": bem$M("cancel"),
        "color": props.cancelButtonColor,
        ...
        "disabled": props.cancelButtonDisabled,
        "onClick": onCancel
      }, null), props.showConfirmButton && _createVNode$P(ActionBarButton, {
        "type": "danger",
        "text": props.confirmButtonText || t$8("confirm"),
        "class": bem$M("confirm"),
        "color": props.confirmButtonColor,
    ...
    return () => {
      ...
      return _createVNode$P(Popup, _mergeProps$f({
        "ref": root,
        "role": "dialog",
...
const {defineComponent: defineComponent$N,createVNode:_createVNode$O} = await importShared('vue');
const [name$M, bem$L] = createNamespace("divider");
const dividerProps = {
  dashed: Boolean,
  hairline: truthProp,
  vertical: Boolean,
...
var stdin_default$R = defineComponent$N({
  name: name$M,
  props: dividerProps,
  setup(props, {
    slots
...
const {ref: ref$r,computed: computed$n,defineComponent: defineComponent$M,createVNode:_createVNode$N} = await importShared('vue');
const [name$L, bem$K] = createNamespace("dropdown-menu");
...
var stdin_default$Q = defineComponent$M({
  name: name$L,
  ...
  setup(props, {
    ...
    const root = ref$r();
    const barRef = ref$r();
    const offset = ref$r(0);
    const {
      children,
      linkChildren
    } = useChildren(DROPDOWN_KEY);
    const scrollParent = useScrollParent(root);
    const opened = computed$n(() => children.some((item) => item.state.showWrapper));
    const scrollable = computed$n(() => props.swipeThreshold && children.length > +props.swipeThreshold);
    const barStyle = computed$n(() => {
...
const {reactive: reactive$7,Teleport: Teleport$3,defineComponent: defineComponent$L,ref: ref$q,createVNode:_createVNode$M,vShow:_vShow$5,mergeProps:_mergeProps$e,withDirectives:_withDirectives$5} = await importShared('vue');
const [name$K, bem$J] = createNamespace("dropdown-item");
...
var stdin_default$P = defineComponent$L({
  name: name$K,
  inheritAttrs: false,
  ...
  setup(props, {
    ...
    const renderContent = () => {
      ...
      return _withDirectives$5(_createVNode$M("div", _mergeProps$e({
        "ref": wrapperRef,
        "style": style,
        "class": bem$J([direction]),
        "onClick": onClickWrapper
      }, attrs), [_createVNode$M(Popup, {
    ...
    return () => {
      if (props.teleport) {
        return _createVNode$M(Teleport$3, {
          "to": props.teleport
        }, {
...
const {Teleport: Teleport$2,computed: computed$m,defineComponent: defineComponent$K,nextTick: nextTick$9,onMounted: onMounted$7,ref: ref$p,watch: watch$f,onActivated: onActivated$1,onDeactivated,createVNode:_createVNode$L,vShow:_vShow$4,mergeProps:_mergeProps$d,withDirectives:_withDirectives$4} = await importShared('vue');
...
const [name$J, bem$I] = createNamespace("floating-bubble");
var stdin_default$O = defineComponent$K({
  name: name$J,
  inheritAttrs: false,
  ...
  setup(props, {
    ...
    const gapX = computed$m(() => isObject(props.gap) ? props.gap.x : props.gap);
    const gapY = computed$m(() => isObject(props.gap) ? props.gap.y : props.gap);
    const boundary = computed$m(() => ({
      top: gapY.value,
      right: windowWidth.value - state.value.width - gapX.value,
      bottom: windowHeight.value - state.value.height - gapY.value,
      left: gapX.value
    }));
    const dragging = ref$p(false);
    let initialized = false;
    const rootStyle = computed$m(() => {
      const style = {};
    ...
    watch$f([windowWidth, windowHeight, gapX, gapY, () => props.offset], updateState, {
      deep: true
    });
    const show = ref$p(true);
    onActivated$1(() => {
      show.value = true;
    });
    onDeactivated(() => {
    ...
    return () => {
      const Content = _withDirectives$4(_createVNode$L("div", _mergeProps$d({
        "class": bem$I(),
        "ref": rootRef,
        "onTouchstartPassive": onTouchStart,
        "onTouchend": onTouchEnd,
        ...
        "style": rootStyle.value
      }, attrs), [slots.default ? slots.default() : _createVNode$L(stdin_default$1M, {
        "name": props.icon,
        "class": bem$I("icon")
      }, null)]), [[_vShow$4, show.value]]);
      return props.teleport ? _createVNode$L(Teleport$2, {
        "to": props.teleport
      }, {
        default: () => [Content]
      }) : Content;
...
const FloatingBubble = withInstall(stdin_default$O);

const {ref: ref$o,watch: watch$e,computed: computed$l,defineComponent: defineComponent$J,createVNode:_createVNode$K} = await importShared('vue');
...
const [name$I, bem$H] = createNamespace("floating-panel");
var stdin_default$N = defineComponent$J({
  name: name$I,
  ...
  setup(props, {
    ...
    const anchors = computed$l(() => props.anchors.length >= 2 ? props.anchors : [boundary.value.min, boundary.value.max]);
    const dragging = ref$o(false);
    const rootStyle = computed$l(() => ({
    ...
    return () => {
      ...
      return _createVNode$K("div", {
        ...
        "onTouchend": onTouchend,
        "onTouchcancel": onTouchend
      }, [renderHeader(), _createVNode$K("div", {
        "class": bem$H("content"),
        "ref": contentRef
      }, [(_a = slots.default) == null ? void 0 : _a.call(slots)])]);
    };
...
const FloatingPanel = withInstall(stdin_default$N);

const {defineComponent: defineComponent$I,createVNode:_createVNode$J} = await importShared('vue');
const [name$H, bem$G] = createNamespace("grid");
const gridProps = {
  square: Boolean,
  center: truthProp,
  border: truthProp,
...
var stdin_default$M = defineComponent$I({
  name: name$H,
  props: gridProps,
  setup(props, {
    slots
...
const {computed: computed$k,defineComponent: defineComponent$H,mergeProps:_mergeProps$c,createVNode:_createVNode$I} = await importShared('vue');
const [name$G, bem$F] = createNamespace("grid-item");
...
var stdin_default$L = defineComponent$H({
  name: name$G,
  props: gridItemProps,
  setup(props, {
    slots
    ...
    const renderIcon = () => {
      if (slots.icon) {
        return _createVNode$I(Badge, _mergeProps$c({
          "dot": props.dot,
          "content": props.badge
        }, props.badgeProps), {
          default: slots.icon
...
const {defineComponent: defineComponent$G,computed: computed$j,createVNode:_createVNode$H} = await importShared('vue');
const [name$F, bem$E] = createNamespace("highlight");
...
var stdin_default$K = defineComponent$G({
  name: name$F,
  props: highlightProps,
  setup(props) {
    const highlightChunks = computed$j(() => {
      const {
        autoEscape,
        caseSensitive,
        keywords,
    ...
    const renderContent = () => {
      ...
      return highlightChunks.value.map((chunk) => {
        ...
        if (highlight) {
          return _createVNode$H(highlightTag, {
            "class": [bem$E("tag"), highlightClass]
          }, {
            default: () => [text]
          });
        }
        return _createVNode$H(unhighlightTag, {
...
const Highlight = withInstall(stdin_default$K);

const {ref: ref$n,watch: watch$d,computed: computed$i,reactive: reactive$6,defineComponent: defineComponent$F,createVNode:_createVNode$G} = await importShared('vue');
...
var stdin_default$J = defineComponent$F({
  ...
  setup(props, {
    ...
    const touch = useTouch();
    const imageRef = ref$n();
    const swipeItem = ref$n();
    const vertical = ref$n(false);
    const isLongImage = ref$n(false);
    let initialMoveY = 0;
    const imageStyle = computed$i(() => {
      const {
        scale,
        moveX,
        moveY,
    ...
    watch$d(() => props.active, resetScale);
    watch$d(() => props.show, (value) => {
      if (!value) {
        resetScale();
      }
    });
    watch$d(() => [props.rootWidth, props.rootHeight], resize);
    useEventListener("touchmove", onTouchMove, {
      target: computed$i(() => {
        var _a;
    ...
    return () => {
      const imageSlots = {
        loading: () => _createVNode$G(Loading, {
          "type": "spinner"
        }, null)
      };
      return _createVNode$G(SwipeItem, {
        "ref": swipeItem,
        ...
        default: () => [slots.image ? _createVNode$G("div", {
          "class": bem$D("image-wrap")
        }, [slots.image({
          src: props.src,
          onLoad,
          style: imageStyle.value
        })]) : _createVNode$G(Image$1, {
          "ref": imageRef,
          "src": props.src,
          "fit": "contain",
          "class": bem$D("image", {
...
const {ref: ref$m,watch: watch$c,nextTick: nextTick$8,reactive: reactive$5,onMounted: onMounted$6,defineComponent: defineComponent$E,createVNode:_createVNode$F,mergeProps:_mergeProps$b} = await importShared('vue');
const [name$E, bem$C] = createNamespace("image-preview");
...
var stdin_default$I = defineComponent$E({
  name: name$E,
  ...
  setup(props, {
    ...
    const swipeRef = ref$m();
    const activedPreviewItemRef = ref$m();
    ...
    const renderImages = () => _createVNode$F(Swipe, {
      "ref": swipeRef,
      "lazyRender": true,
      "loop": props.loop,
      "class": bem$C("swipe"),
      ...
      default: () => [props.images.map((image, index) => _createVNode$F(stdin_default$J, {
        "ref": (item) => {
    ...
    const renderClose = () => {
      if (props.closeable) {
        return _createVNode$F(Icon, {
          "role": "button",
          "name": props.closeIcon,
          "class": [bem$C("close-icon", props.closeIconPosition), HAPTICS_FEEDBACK],
          "onClick": emitClose
        }, null);
      }
    };
    ...
    onMounted$6(resize);
    watch$c([windowWidth, windowHeight], resize);
    watch$c(() => props.startPosition, (value) => setActive(+value));
    watch$c(() => props.show, (value) => {
      const {
        images,
        startPosition
      } = props;
    ...
    return () => _createVNode$F(Popup, _mergeProps$b({
      "class": [bem$C(), props.className],
      "overlayClass": [bem$C("overlay"), props.overlayClass],
      "onClosed": onClosed,
      "onUpdate:show": updateShow
...
const {mergeProps:_mergeProps$a,createVNode:_createVNode$E} = await importShared('vue');
let instance;
const defaultConfig = {
  loop: true,
  images: [],
...
function initInstance() {
  ({
    ...
    setup() {
      ...
      return () => _createVNode$E(stdin_default$I, _mergeProps$a(state, {
        "onClosed": onClosed,
        "onUpdate:show": toggle
      }), null);
    }
...
const {ref: ref$l,watch: watch$b,computed: computed$h,nextTick: nextTick$7,Teleport: Teleport$1,onMounted: onMounted$5,defineComponent: defineComponent$D,createVNode:_createVNode$D} = await importShared('vue');
function genAlphabet() {
  const charCodeOfA = "A".charCodeAt(0);
  const indexList = Array(26).fill("").map((_, i) => String.fromCharCode(charCodeOfA + i));
  return indexList;
}
const [name$D, bem$B] = createNamespace("index-bar");
const indexBarProps = {
  sticky: truthProp,
  zIndex: numericProp,
  teleport: [String, Object],
...
var stdin_default$H = defineComponent$D({
  name: name$D,
  props: indexBarProps,
  emits: ["select", "change"],
  setup(props, {
    ...
    const highlightStyle = computed$h(() => {
    ...
    onMounted$5(init);
    watch$b(() => props.indexList, init);
    watch$b(activeAnchor, (value) => {
      if (value) {
        emit("change", value);
      }
    });
    ...
    const renderSidebar = () => _createVNode$D("div", {
      "ref": sidebar,
      "class": bem$B("sidebar"),
    ...
    return () => {
      ...
      return _createVNode$D("div", {
        "ref": root,
        "class": bem$B()
      }, [props.teleport ? _createVNode$D(Teleport$1, {
        "to": props.teleport
      }, {
...
const {ref: ref$k,reactive: reactive$4,computed: computed$g,defineComponent: defineComponent$C,createVNode:_createVNode$C} = await importShared('vue');
const [name$C, bem$A] = createNamespace("index-anchor");
const indexAnchorProps = {
  index: numericProp
};
var stdin_default$G = defineComponent$C({
  name: name$C,
...
const {ref: ref$j,watch: watch$a,computed: computed$f,nextTick: nextTick$6,onUpdated,onMounted: onMounted$4,defineComponent: defineComponent$B,createVNode:_createVNode$B} = await importShared('vue');
const [name$B, bem$z, t$7] = createNamespace("list");
const listProps = {
  error: Boolean,
...
var stdin_default$F = defineComponent$B({
  name: name$B,
  props: listProps,
  ...
  setup(props, {
    ...
    const loading = ref$j(props.loading);
    const root = ref$j();
    const placeholder = ref$j();
    const tabStatus = useAllTabStatus();
    const scrollParent = useScrollParent(root);
    const scroller = computed$f(() => props.scroller || scrollParent.value);
    const check = () => {
      nextTick$6(() => {
    ...
    const renderLoading = () => {
      if (loading.value && !props.finished && !props.disabled) {
        return _createVNode$B("div", {
          "class": bem$z("loading")
        }, [slots.loading ? slots.loading() : _createVNode$B(Loading, {
    ...
    watch$a(() => [props.loading, props.finished, props.error], check);
    if (tabStatus) {
      watch$a(tabStatus, (tabActive) => {
        if (tabActive) {
          check();
        }
      });
    ...
    return () => {
      var _a;
      const Content = (_a = slots.default) == null ? void 0 : _a.call(slots);
      const Placeholder = _createVNode$B("div", {
        "ref": placeholder,
...
const {ref: ref$i,defineComponent: defineComponent$A,createVNode:_createVNode$A} = await importShared('vue');
const [name$A, bem$y] = createNamespace("nav-bar");
const navBarProps = {
  title: String,
  fixed: Boolean,
  zIndex: numericProp,
...
var stdin_default$E = defineComponent$A({
  name: name$A,
  props: navBarProps,
  ...
  setup(props, {
    ...
    const navBarRef = ref$i();
    const renderPlaceholder = usePlaceholder(navBarRef, bem$y);
    ...
    const renderLeft = () => {
      ...
      return [props.leftArrow && _createVNode$A(Icon, {
        "class": bem$y("arrow"),
        "name": "arrow-left"
      }, null), props.leftText && _createVNode$A("span", {
        "class": bem$y("text")
      }, [props.leftText])];
    };
    const renderRight = () => {
    ...
    const renderNavBar = () => {
      ...
      return _createVNode$A("div", {
        ...
        "class": bem$y("content")
      }, [hasLeft && _createVNode$A("div", {
        "class": [bem$y("left", {
          disabled: props.leftDisabled
        }), props.clickable && !props.leftDisabled ? HAPTICS_FEEDBACK : ""],
        "onClick": onClickLeft
      }, [renderLeft()]), _createVNode$A("div", {
        "class": [bem$y("title"), "van-ellipsis"]
      }, [slots.title ? slots.title() : title]), hasRight && _createVNode$A("div", {
        "class": [bem$y("right", {
...
const {ref: ref$h,watch: watch$9,reactive: reactive$3,defineComponent: defineComponent$z,createVNode:_createVNode$z,vShow:_vShow$3,withDirectives:_withDirectives$3} = await importShared('vue');
const [name$z, bem$x] = createNamespace("notice-bar");
...
var stdin_default$D = defineComponent$z({
  name: name$z,
  ...
  setup(props, {
    ...
    watch$9(() => [props.text, props.scrollable], reset);
    return () => {
      const {
        color,
        wrapable,
      ...
      return _withDirectives$3(_createVNode$z("div", {
        "role": "alert",
        "class": bem$x({
          wrapable
        }),
      ...
      }, [renderLeftIcon(), renderMarquee(), renderRightIcon()]), [[_vShow$3, state.show]]);
    };
  }
});
...
const {ref: ref$g,defineComponent: defineComponent$y,createVNode:_createVNode$y} = await importShared('vue');
const [name$y, bem$w] = createNamespace("key");
const CollapseIcon = _createVNode$y("svg", {
...
const DeleteIcon = _createVNode$y("svg", {
...
var stdin_default$C = defineComponent$y({
  name: name$y,
  props: {
    type: String,
    text: numericProp,
...
const {ref: ref$f,watch: watch$8,computed: computed$e,Teleport,Transition,defineComponent: defineComponent$x,createVNode:_createVNode$x,vShow:_vShow$2,mergeProps:_mergeProps$9,withDirectives:_withDirectives$2} = await importShared('vue');
const [name$x, bem$v] = createNamespace("number-keyboard");
...
var stdin_default$B = defineComponent$x({
  name: name$x,
  inheritAttrs: false,
  ...
  setup(props, {
    ...
    const keys = computed$e(() => props.theme === "custom" ? genCustomKeys() : genDefaultKeys());
    const onBlur = () => {
      if (props.show) {
        emit("blur");
      }
    ...
    const renderTitle = () => {
      ...
      return _createVNode$x("div", {
        "class": bem$v("header")
      }, [leftSlot && _createVNode$x("span", {
        "class": bem$v("title-left")
      }, [leftSlot()]), title && _createVNode$x("h2", {
        "class": bem$v("title")
      }, [title]), showClose && _createVNode$x("button", {
        "type": "button",
    ...
    const renderKeys = () => keys.value.map((key) => {
      ...
      return _createVNode$x(stdin_default$C, {
        "key": key.text,
        "text": key.text,
        "type": key.type,
        "wider": key.wider,
    ...
    const renderSidebar = () => {
      if (props.theme === "custom") {
        return _createVNode$x("div", {
          "class": bem$v("sidebar")
        }, [props.showDeleteKey && _createVNode$x(stdin_default$C, {
          "large": true,
        ...
        }), _createVNode$x(stdin_default$C, {
          "large": true,
    ...
    return () => {
      ...
      const Content = _createVNode$x(Transition, {
        "name": props.transition ? "van-slide-up" : ""
      }, {
        default: () => [_withDirectives$2(_createVNode$x("div", _mergeProps$9({
          "ref": root,
        ...
        }, attrs), [Title, _createVNode$x("div", {
          "class": bem$v("body")
        }, [_createVNode$x("div", {
          "class": bem$v("keys")
        }, [renderKeys()]), renderSidebar()])]), [[_vShow$2, props.show]])]
      });
      if (props.teleport) {
        return _createVNode$x(Teleport, {
          "to": props.teleport
        }, {
          default: () => [Content]
        });
...
const {computed: computed$d,watchEffect: watchEffect$2,defineComponent: defineComponent$w,createVNode:_createVNode$w} = await importShared('vue');
const [name$w, bem$u, t$6] = createNamespace("pagination");
...
var stdin_default$A = defineComponent$w({
  name: name$w,
  ...
  setup(props, {
    ...
    watchEffect$2(() => updateModelValue(props.modelValue));
    const renderDesc = () => _createVNode$w("li", {
    ...
    const renderPages = () => pages.value.map((page) => _createVNode$w("li", {
      "class": [bem$u("item", {
        active: page.active,
        page: true
      }), BORDER_SURROUND]
...
const {defineComponent: defineComponent$v,createVNode:_createVNode$v} = await importShared('vue');
const [name$v, bem$t] = createNamespace("password-input");
  ...
  setup(props, {
    ...
    const renderPoints = () => {
      ...
      for (let i = 0; i < length; i++) {
        ...
        Points.push(_createVNode$v("li", {
          ...
          "style": style
        }, [mask ? _createVNode$v("i", {
          "style": {
            visibility: char ? "visible" : "hidden"
          }
        }, null) : char, showCursor && _createVNode$v("div", {
          "class": bem$t("cursor")
        }, null)]));
      }
      return Points;
    ...
    return () => {
      ...
      return _createVNode$v("div", {
        ...
        "onTouchstartPassive": onTouchStart
      }, [renderPoints()]), info && _createVNode$v("div", {
        "class": bem$t(props.errorInfo ? "error-info" : "info")
      }, [info])]);
    };
  }
});
...
const {ref: ref$e,watch: watch$7,nextTick: nextTick$5,onMounted: onMounted$3,watchEffect: watchEffect$1,onBeforeUnmount: onBeforeUnmount$1,defineComponent: defineComponent$u,createVNode:_createVNode$u,Fragment:_Fragment$1,mergeProps:_mergeProps$8} = await importShared('vue');
const [name$u, bem$s] = createNamespace("popover");
...
var stdin_default$y = defineComponent$u({
  ...
  setup(props, {
    ...
    let popper;
    const popupRef = ref$e();
    const wrapperRef = ref$e();
    const popoverRef = ref$e();
    ...
    const renderActionContent = (action, index) => {
      ...
      return [action.icon && _createVNode$u(Icon, {
        "name": action.icon,
        "classPrefix": props.iconPrefix,
    ...
    watch$7(() => [show.value, props.offset, props.placement], updateLocation);
    useClickAway([wrapperRef, popupRef], onClickAway, {
      eventName: "touchstart"
    });
    return () => {
      var _a;
      return _createVNode$u(_Fragment$1, null, [_createVNode$u("span", {
        "ref": wrapperRef,
        "class": bem$s("wrapper"),
        "onClick": onClickWrapper
      }, [(_a = slots.reference) == null ? void 0 : _a.call(slots)]), _createVNode$u(Popup, _mergeProps$8({
        "ref": popoverRef,
        "show": show.value,
        "class": bem$s([props.theme]),
        "position": "",
        "transition": "van-popover-zoom",
        "lockScroll": false,
        "onUpdate:show": updateShow
      }, attrs, useScopeId(), pick(props, popupProps)), {
        default: () => [props.showArrow && _createVNode$u("div", {
          "class": bem$s("arrow")
        }, null), _createVNode$u("div", {
          "role": "menu",
          "class": bem$s("content", props.actionsDirection)
...
const {computed: computed$c,defineComponent: defineComponent$t,createVNode:_createVNode$t} = await importShared('vue');
const [name$t, bem$r] = createNamespace("progress");
const progressProps = {
  color: String,
  inactive: Boolean,
  pivotText: String,
...
var stdin_default$x = defineComponent$t({
  ...
  props: progressProps,
  setup(props) {
    const background = computed$c(() => props.inactive ? void 0 : props.color);
...
const {ref: ref$d,watch: watch$6,reactive: reactive$2,nextTick: nextTick$4,defineComponent: defineComponent$s,createVNode:_createVNode$s} = await importShared('vue');
const [name$s, bem$q, t$5] = createNamespace("pull-refresh");
  ...
  setup(props, {
    ...
    const renderStatus = () => {
      ...
      if (TEXT_STATUS.includes(status)) {
        nodes.push(_createVNode$s("div", {
          "class": bem$q("text")
        }, [getStatusText()]));
      }
      if (status === "loading") {
        nodes.push(_createVNode$s(Loading, {
          "class": bem$q("loading")
        }, {
    ...
    const onTouchEnd = () => {
      if (reachTop && touch.deltaY.value && isTouchable()) {
        ...
        if (state.status === "loosing") {
          ...
          nextTick$4(() => emit("refresh"));
        } else {
          setStatus(0);
        }
      }
    };
    watch$6(() => props.modelValue, (value) => {
      state.duration = +props.animationDuration;
      if (value) {
        setStatus(+props.headHeight, true);
...
const {computed: computed$b,defineComponent: defineComponent$r,ref: ref$c,createVNode:_createVNode$r} = await importShared('vue');
const [name$r, bem$p] = createNamespace("rate");
...
var stdin_default$v = defineComponent$r({
  ...
  setup(props, {
    ...
    const groupRef = ref$c();
    const unselectable = computed$b(() => props.readonly || props.disabled);
    const untouchable = computed$b(() => unselectable.value || !props.touchable);
    const list = computed$b(() => Array(+props.count).fill("").map((_, i) => getRateStatus(props.modelValue, i + 1, props.allowHalf, props.readonly)));
    let ranges;
    let groupRefRect;
    ...
    const renderStar = (item, index) => {
      ...
      return _createVNode$r("div", {
        ...
        "classPrefix": iconPrefix
      }, null), renderHalf && _createVNode$r(Icon, {
        "size": size,
        "style": {
          width: item.value + "em"
        },
...
const {defineComponent: defineComponent$q,computed: computed$a,createVNode:_createVNode$q} = await importShared('vue');
const props = {
...
const [name$q, bem$o] = createNamespace("rolling-text-item");
var stdin_default$u = defineComponent$q({
  name: name$q,
  props,
  setup(props2) {
    const newFigureArr = computed$a(() => props2.direction === "down" ? props2.figureArr.slice().reverse() : props2.figureArr);
    const translatePx = computed$a(() => {
      const totalHeight = props2.height * (props2.figureArr.length - 1);
      return `-${totalHeight}px`;
    });
    const itemStyle = computed$a(() => ({
      lineHeight: addUnit(props2.height)
    }));
    const rootStyle = computed$a(() => ({
    ...
    }, [Array.isArray(newFigureArr.value) && newFigureArr.value.map((figure) => _createVNode$q("div", {
      "class": bem$o("item"),
...
const {ref: ref$b,defineComponent: defineComponent$p,computed: computed$9,watch: watch$5,createVNode:_createVNode$p} = await importShared('vue');
const [name$p, bem$n] = createNamespace("rolling-text");
...
var stdin_default$t = defineComponent$p({
  ...
  setup(props) {
    const isCustomType = computed$9(() => Array.isArray(props.textList) && props.textList.length);
    const itemLength = computed$9(() => {
    ...
    const rolling = ref$b(props.autoStart);
    const start = () => {
      rolling.value = true;
    };
    const reset = () => {
    ...
    return () => _createVNode$p("div", {
      "class": bem$n()
    }, [targetNumArr.value.map((_, i) => _createVNode$p(stdin_default$u, {
...
const {ref: ref$a,defineComponent: defineComponent$o,createVNode:_createVNode$o,mergeProps:_mergeProps$7} = await importShared('vue');
const [name$o, bem$m, t$4] = createNamespace("search");
...
var stdin_default$s = defineComponent$o({
  ...
  setup(props, {
    ...
    const renderField = () => {
      ...
      return _createVNode$o(Field, _mergeProps$7({
        "ref": fieldRef,
        "type": "search",
        "class": bem$m("field", {
    ...
    return () => {
      ...
      }, [(_a = slots.left) == null ? void 0 : _a.call(slots), _createVNode$o("div", {
...
const {defineComponent: defineComponent$n,createVNode:_createVNode$n,mergeProps:_mergeProps$6} = await importShared('vue');
...
const [name$n, bem$l, t$3] = createNamespace("share-sheet");
  ...
  setup(props, {
    ...
    const renderHeader = () => {
      ...
      if (title || description) {
        return _createVNode$n("div", {
          "class": bem$l("header")
        }, [title && _createVNode$n("h2", {
          "class": bem$l("title")
        }, [title]), description && _createVNode$n("span", {
    ...
    const renderOption = (option, index) => {
      ...
      }, [renderIcon(icon), name2 && _createVNode$n("span", {
        "class": bem$l("name")
      }, [name2]), description && _createVNode$n("span", {
        "class": bem$l("option-description")
      }, [description])]);
    };
    const renderOptions = (options, border) => _createVNode$n("div", {
      "class": bem$l("options", {
        border
      })
    ...
    return () => _createVNode$n(Popup, _mergeProps$6({
      "class": bem$l(),
      "position": "bottom",
      "onUpdate:show": updateShow
...
const {defineComponent: defineComponent$m,createVNode:_createVNode$m} = await importShared('vue');
const [name$m, bem$k] = createNamespace("sidebar");
...
const {defineComponent: defineComponent$l,mergeProps:_mergeProps$5,createVNode:_createVNode$l} = await importShared('vue');
const [name$l, bem$j] = createNamespace("sidebar-item");
  ...
  setup(props, {
    ...
    return () => {
      ...
      return _createVNode$l("div", {
        ...
        "onClick": onClick
      }, [_createVNode$l(Badge, _mergeProps$5({
        "dot": dot,
        "class": bem$j("text"),
        "content": badge
      }, props.badgeProps), {
...
const {computed: computed$8,ref: ref$9,onMounted: onMounted$2,defineComponent: defineComponent$k,watch: watch$4,createVNode:_createVNode$k} = await importShared('vue');
const [name$k, bem$i, t$2] = createNamespace("signature");
...
var stdin_default$o = defineComponent$k({
  ...
  setup(props, {
    ...
    const canvasRef = ref$9();
    const wrapRef = ref$9();
    const ctx = computed$8(() => {
    ...
    watch$4(windowWidth, resize);
    onMounted$2(initialize);
    useExpose({
      resize,
      clear,
      submit
    ...
    return () => _createVNode$k("div", {
      ...
      "class": bem$i("content"),
      "ref": wrapRef
    }, [isRenderCanvas ? _createVNode$k("canvas", {
      "ref": canvasRef,
      "onTouchstartPassive": touchStart,
      "onTouchmove": touchMove,
      "onTouchend": touchEnd
    }, null) : slots.tips ? slots.tips() : _createVNode$k("p", null, [props.tips])]), _createVNode$k("div", {
      "class": bem$i("footer")
    }, [_createVNode$k(Button, {
      "size": "small",
      "onClick": clear
    }, {
...
const {defineComponent: defineComponent$j,createVNode:_createVNode$j} = await importShared('vue');
const [name$j, bem$h] = createNamespace("skeleton-title");
...
const {defineComponent: defineComponent$i,createVNode:_createVNode$i} = await importShared('vue');
const [name$i, bem$g] = createNamespace("skeleton-avatar");
const skeletonAvatarProps = {
  avatarSize: numericProp,
  avatarShape: makeStringProp("round")
};
var stdin_default$l = defineComponent$i({
  name: name$i,
...
const {defineComponent: defineComponent$h,createVNode:_createVNode$h} = await importShared('vue');
...
const [name$h, bem$f] = createNamespace("skeleton-paragraph");
var stdin_default$j = defineComponent$h({
  name: name$h,
...
const {defineComponent: defineComponent$g,createVNode:_createVNode$g,Fragment:_Fragment,mergeProps:_mergeProps$4} = await importShared('vue');
const [name$g, bem$e] = createNamespace("skeleton");
...
var stdin_default$h = defineComponent$g({
  name: name$g,
  inheritAttrs: false,
  props: skeletonProps,
  setup(props, {
    ...
    const renderAvatar = () => {
      if (props.avatar) {
        return _createVNode$g(stdin_default$k, {
    ...
    const renderTitle = () => {
      if (props.title) {
        return _createVNode$g(stdin_default$m, {
          "round": props.round,
    ...
    const renderRows = () => Array(+props.row).fill("").map((_, i) => _createVNode$g(stdin_default$i, {
      "key": i,
      "round": props.round,
    ...
    const renderContents = () => {
      ...
      return _createVNode$g(_Fragment, null, [renderAvatar(), _createVNode$g("div", {
        "class": bem$e("content")
    ...
    return () => {
      ...
      return _createVNode$g("div", _mergeProps$4({
        "class": bem$e({
...
const {defineComponent: defineComponent$f,createVNode:_createVNode$f} = await importShared('vue');
const [name$f, bem$d] = createNamespace("skeleton-image");
const skeletonImageProps = {
  imageSize: numericProp,
  imageShape: makeStringProp("square")
};
var stdin_default$g = defineComponent$f({
  name: name$f,
...
const {ref: ref$8,computed: computed$7,defineComponent: defineComponent$e,createVNode:_createVNode$e} = await importShared('vue');
const [name$e, bem$c] = createNamespace("slider");
const sliderProps = {
...
var stdin_default$f = defineComponent$e({
  name: name$e,
  props: sliderProps,
  ...
  setup(props, {
    ...
    let startValue;
    const root = ref$8();
    const slider = [ref$8(), ref$8()];
    const dragStatus = ref$8();
    const touch = useTouch();
    const scope = computed$7(() => Number(props.max) - Number(props.min));
    const wrapperStyle = computed$7(() => {
      const crossAxis = props.vertical ? "width" : "height";
      return {
...
const {computed: computed$6,Comment,defineComponent: defineComponent$d,Fragment,Text,createVNode:_createVNode$d} = await importShared('vue');
const [name$d, bem$b] = createNamespace("space");
const spaceProps = {
  align: String,
  direction: {
    type: String,
...
var stdin_default$e = defineComponent$d({
  name: name$d,
  props: spaceProps,
  setup(props, {
    slots
  }) {
    const mergedAlign = computed$6(() => {
      var _a;
    ...
    return () => {
      ...
      }, [children.map((c, i) => _createVNode$d("div", {
        "key": `item-${i}`,
        "class": `${name$d}-item`,
...
const {defineComponent: defineComponent$c,createVNode:_createVNode$c} = await importShared('vue');
const [name$c, bem$a] = createNamespace("steps");
const stepsProps = {
  active: makeNumericProp(0),
...
const STEPS_KEY = Symbol(name$c);
var stdin_default$d = defineComponent$c({
  name: name$c,
  props: stepsProps,
  emits: ["clickStep"],
  setup(props, {
...
const {computed: computed$5,defineComponent: defineComponent$b,createVNode:_createVNode$b} = await importShared('vue');
const [name$b, bem$9] = createNamespace("step");
var stdin_default$c = defineComponent$b({
  name: name$b,
  setup(props, {
    slots
  }) {
    ...
    return () => {
      ...
      return _createVNode$b("div", {
        ...
        "onClick": onClickStep
      }, [(_a = slots.default) == null ? void 0 : _a.call(slots)]), _createVNode$b("div", {
        "class": bem$9("circle-container"),
        "onClick": onClickStep
      }, [renderCircle()]), _createVNode$b("div", {
        "class": bem$9("line"),
        "style": lineStyle.value
      }, null)]);
    };
...
const {ref: ref$7,watch: watch$3,computed: computed$4,nextTick: nextTick$3,defineComponent: defineComponent$a,vShow:_vShow$1,mergeProps:_mergeProps$3,createVNode:_createVNode$a,withDirectives:_withDirectives$1} = await importShared('vue');
const [name$a, bem$8] = createNamespace("stepper");
...
var stdin_default$b = defineComponent$a({
  name: name$a,
  props: stepperProps,
  ...
  setup(props, {
    ...
    let actionType;
    const inputRef = ref$7();
    const current = ref$7(getInitialValue());
    const minusDisabled = computed$4(() => props.disabled || props.disableMinus || +current.value <= +props.min);
    const plusDisabled = computed$4(() => props.disabled || props.disablePlus || +current.value >= +props.max);
    const inputStyle = computed$4(() => ({
      width: addUnit(props.inputWidth),
      height: addUnit(props.buttonSize)
    }));
    const buttonStyle = computed$4(() => getSizeStyle(props.buttonSize));
    const check = () => {
    ...
    watch$3(() => [props.max, props.min, props.integer, props.decimalLength], check);
    watch$3(() => props.modelValue, (value) => {
      if (!isEqual(value, current.value)) {
        current.value = format(value);
      }
    });
    watch$3(current, (value) => {
      emit("update:modelValue", value);
      emit("change", value, {
        name: props.name
      });
    ...
    }, [_withDirectives$1(_createVNode$a("button", _mergeProps$3({
      "type": "button",
    ...
    }, createListeners("minus")), null), [[_vShow$1, props.showMinus]]), _withDirectives$1(_createVNode$a("input", {
      "ref": inputRef,
    ...
    }, null), [[_vShow$1, props.showInput]]), _withDirectives$1(_createVNode$a("button", _mergeProps$3({
      "type": "button",
      "style": buttonStyle.value,
      "class": [bem$8("plus", {
    ...
    }, createListeners("plus")), null), [[_vShow$1, props.showPlus]])]);
  }
});
...
const {ref: ref$6,defineComponent: defineComponent$9,createVNode:_createVNode$9} = await importShared('vue');
const [name$9, bem$7, t$1] = createNamespace("submit-bar");
...
var stdin_default$a = defineComponent$9({
  name: name$9,
  ...
  setup(props, {
    ...
    const renderText = () => {
      ...
      if (typeof price === "number") {
        ...
        return _createVNode$9("div", {
          "class": bem$7("text"),
          "style": {
            textAlign
          }
        }, [_createVNode$9("span", null, [label || t$1("label")]), _createVNode$9("span", {
          "class": bem$7("price")
        }, [currency, _createVNode$9("span", {
          "class": bem$7("price-integer")
        }, [pricePair[0]]), decimal]), suffixLabel && _createVNode$9("span", {
    ...
    const renderTip = () => {
      ...
      if (slots.tip || tip) {
        return _createVNode$9("div", {
          "class": bem$7("tip")
        }, [tipIcon && _createVNode$9(Icon, {
          "class": bem$7("tip-icon"),
          "name": tipIcon
        }, null), tip && _createVNode$9("span", {
    ...
    const renderSubmitBar = () => {
      ...
      }, [(_a = slots.top) == null ? void 0 : _a.call(slots), renderTip(), _createVNode$9("div", {
        "class": bem$7("bar")
...
const {ref: ref$5,reactive: reactive$1,computed: computed$3,defineComponent: defineComponent$8,createVNode:_createVNode$8} = await importShared('vue');
const [name$8, bem$6] = createNamespace("swipe-cell");
...
var stdin_default$9 = defineComponent$8({
  name: name$8,
  ...
  setup(props, {
    ...
    const leftWidth = computed$3(() => isDef(props.leftWidth) ? +props.leftWidth : getWidthByRef(leftRef));
    const rightWidth = computed$3(() => isDef(props.rightWidth) ? +props.rightWidth : getWidthByRef(rightRef));
    const open = (side) => {
...
const {ref: ref$4,defineComponent: defineComponent$7,createVNode:_createVNode$7} = await importShared('vue');
const [name$7, bem$5] = createNamespace("tabbar");
const tabbarProps = {
  route: Boolean,
  fixed: truthProp,
  border: truthProp,
...
const TABBAR_KEY = Symbol(name$7);
...
const {computed: computed$2,defineComponent: defineComponent$6,getCurrentInstance,createVNode:_createVNode$6,mergeProps:_mergeProps$2} = await importShared('vue');
const [name$6, bem$4] = createNamespace("tabbar-item");
  ...
  setup(props, {
    ...
    return () => {
      ...
      return _createVNode$6("div", {
        ...
        "onClick": onClick
      }, [_createVNode$6(Badge, _mergeProps$2({
        "dot": dot,
        "class": bem$4("icon"),
        "content": badge
      }, props.badgeProps), {
...
const {ref: ref$3,watch: watch$2,computed: computed$1,onActivated,onMounted: onMounted$1,defineComponent: defineComponent$5,nextTick: nextTick$2,createVNode:_createVNode$5} = await importShared('vue');
const [name$5, bem$3] = createNamespace("text-ellipsis");
...
var stdin_default$6 = defineComponent$5({
  ...
  setup(props, {
    ...
    const text = ref$3(props.content);
    const expanded = ref$3(false);
    const hasAction = ref$3(false);
    const root = ref$3();
    const actionRef = ref$3();
    let needRecalculate = false;
    const actionText = computed$1(() => expanded.value ? props.collapseText : props.expandText);
    const pxToNum = (value) => {
      if (!value) return 0;
    ...
    watch$2([windowWidth, () => [props.content, props.rows, props.position]], calcEllipsised);
    useExpose({
      toggle
    });
    return () => _createVNode$5("div", {
      "ref": root,
      "class": bem$3()
...
const {computed,defineComponent: defineComponent$4,ref: ref$2,watch: watch$1,mergeProps:_mergeProps$1,createVNode:_createVNode$4} = await importShared('vue');
const [name$4] = createNamespace("time-picker");
...
var stdin_default$5 = defineComponent$4({
  ...
  setup(props, {
    ...
    const currentValues = ref$2(props.modelValue);
    const pickerRef = ref$2();
    ...
    watch$1(currentValues, (newValues) => {
      if (!isSameValue(newValues, props.modelValue)) {
        emit("update:modelValue", newValues);
      }
    });
    watch$1(() => props.modelValue, (newValues) => {
      newValues = formatValueRange(newValues, columns.value);
      if (!isSameValue(newValues, currentValues.value)) {
        currentValues.value = newValues;
      }
    ...
    return () => _createVNode$4(Picker, _mergeProps$1({
      "ref": pickerRef,
      "modelValue": currentValues.value,
      "onUpdate:modelValue": ($event) => currentValues.value = $event,
      "columns": columns.value,
...
const {defineComponent: defineComponent$3,createVNode:_createVNode$3} = await importShared('vue');
const [name$3, bem$2] = createNamespace("tree-select");
  ...
  setup(props, {
    ...
    const renderSubItem = (item) => {
      ...
      return _createVNode$3("div", {
        ...
        "onClick": onClick
      }, [item.text, isActiveItem(item.id) && _createVNode$3(Icon, {
    ...
    const renderSidebar = () => {
      const Items = props.items.map((item) => _createVNode$3(SidebarItem, {
        "dot": item.dot,
        "badge": item.badge,
    ...
    }, [renderSidebar(), _createVNode$3("div", {
      "class": bem$2("content")
    }, [renderContent()])]);
  }
});
...
const [name$2, bem$1, t] = createNamespace("uploader");
...
const {defineComponent: defineComponent$2,createVNode:_createVNode$2} = await importShared('vue');
var stdin_default$3 = defineComponent$2({
  props: {
    name: numericProp,
    item: makeRequiredProp(Object),
    index: Number,
  ...
  setup(props, {
    ...
    const renderMask = () => {
      ...
      if (status === "uploading" || status === "failed") {
        const MaskIcon = status === "failed" ? _createVNode$2(Icon, {
          "name": "close",
          "class": bem$1("mask-icon")
        }, null) : _createVNode$2(Loading, {
          "class": bem$1("loading")
        }, null);
        const showMessage = isDef(message) && message !== "";
        return _createVNode$2("div", {
          "class": bem$1("mask")
        }, [MaskIcon, showMessage && _createVNode$2("div", {
...
const {ref: ref$1,reactive,defineComponent: defineComponent$1,onBeforeUnmount,nextTick: nextTick$1,mergeProps:_mergeProps,createVNode:_createVNode$1,vShow:_vShow,withDirectives:_withDirectives} = await importShared('vue');
const uploaderProps = {
  name: makeNumericProp(""),
...
var stdin_default$2 = defineComponent$1({
  name: name$2,
  props: uploaderProps,
  ...
  setup(props, {
    ...
    const urls = [];
    const reuploadIndex = ref$1(-1);
    const isReuploading = ref$1(false);
    ...
    const renderPreviewItem = (item, index) => {
      ...
      return _createVNode$1(stdin_default$3, _mergeProps({
        "item": item,
        "index": index,
    ...
    const renderUpload = () => {
      ...
      const Input = props.readonly ? null : _createVNode$1("input", {
        "ref": inputRef,
        "type": "file",
        "class": bem$1("input"),
        "accept": props.accept,
      ...
      if (slots.default) {
        return _withDirectives(_createVNode$1("div", {
      ...
      }, null), props.uploadText && _createVNode$1("span", {
...
const {defineComponent,nextTick,onMounted,onUnmounted,ref,watch,watchEffect,createVNode:_createVNode} = await importShared('vue');
const [name$1, bem] = createNamespace("watermark");
...
// import mqttmsg from '@/mqttmsg.js'
// import EventBus from '@/event/eventbus'
// console.log(mqtt.connect)
const plugins = {
  client: null,
  mqttStore: null,
  async install(app_arg, options) {
    this.mqttStore = useMqttStore();
    this.userStore = useUserStore();
    app_arg.config.globalProperties.$mqtt = this;
    // uni.$mqtt = this
  },
  handShaking() {
    console.log("handShaking", mqtt);
    if (this.client && this.isConnected()) {
      this.disconnect();
    }
    const { brokerUrl, username, password, gatewayMac } = this.mqttStore;
    const { run_version } = this.userStore;
    try {
      let option = {
        connectTimeout: 40000,
        keepalive: 30,
        reconnectPeriod: 5000,
        clientId: "rom" + Math.random() * 100,
        clean: true,
        reconnect: true, // 连接中断后会重新连接
        username: username,
        password: password,
      };
      this.client = mqtt.connect(brokerUrl, option); // APP
    } catch (e) {
      console.log("eeeeeeeeeeeee");
      console.log(e);
      if (this.mqttStore) {
        this.mqttStore.state = 0;
      }
      return;
    }
    // mqtt连接
    this.client.on("connect", () => {
      // EventBus.post(EventBus.MQTT_EVENT.CONNECT_SUCCESS)
      console.log("连接成功:", this.mqttStore);
      if (this.mqttStore) {
        this.mqttStore.state = 1;
        showNotify({ type: "success", message: `网络连接成功` });
        this.subscribe(`post/state`, 0);

        // 调试
        // this.publish(`${username}/${gatewayMac}/run_version`, "0", 0);
        // 跳转
        // this.mqttStore.tabValue = 0;
      }
    });
    // 接收消息处理
    this.client.on("message", (topic, message) => {
      ...
      console.log(msg); // 0_1/2/3
      let temp = msg.split("_");
      if (temp[0] === this.mqttStore.userId) {
        console.log(temp[1]);
        if (["1", "2", "3"].includes(temp[1])) {
          this.mqttStore.setDoorState(Number(temp[1]));
          showNotify({
            type: "success",
            message: `${
              (temp[1] === "1" && "已停止") ||
          ...
          showNotify({
            message:
              (temp[1] === "401" && "登陆过期") ||
              (temp[1] === "500" && "参数错误") ||
              (temp[1] === "502" && "系统繁忙,稍后再试") ||
              "未知错误",
          });
        }
        this.mqttStore.setBtnLoading(false);
      }
      if (this.mqttStore) ;
    });
    // 断开发起重连
    ...
    this.client.on("disconnect", () => {
      // EventBus.post(EventBus.MQTT_EVENT.CONNECT_LOST)
      console.log("断开链接:");
      if (this.mqttStore) {
        this.mqttStore.state = 0;
      }
    ...
    this.client.on("error", (error) => {
      // EventBus.post(EventBus.MQTT_EVENT.CONNECT_FAILED)
  ...
  publish(topic, msg, qos) {
    this.client.publish(topic, msg, { qos: qos }, (error) => {
      if (!error) {
