...
const {ref:ref2,inject: inject$3,computed: computed$5,onUnmounted: onUnmounted$1,getCurrentInstance: getCurrentInstance$5} = await importShared('vue');
...
const {isVNode,provide: provide$2,reactive: reactive$3,getCurrentInstance:getCurrentInstance2} = await importShared('vue');
...
const {ref:ref3,computed:computed2,onActivated: onActivated$2,onDeactivated: onDeactivated$3,onBeforeUnmount: onBeforeUnmount$2} = await importShared('vue');
...
const {watch: watch$8,isRef: isRef$1,unref:unref2,onUnmounted:onUnmounted2,onDeactivated:onDeactivated2} = await importShared('vue');


// src/onMountedOrActivated/index.ts
const {nextTick: nextTick$3,onMounted: onMounted$2,onActivated:onActivated2} = await importShared('vue');
...
const {computed: computed$4,defineComponent: defineComponent$5,createVNode:_createVNode$8} = await importShared('vue');
...
const {watch: watch$6,provide: provide$1,computed: computed$3,watchEffect,onActivated: onActivated$1,onDeactivated: onDeactivated$2,onBeforeUnmount: onBeforeUnmount$1,defineComponent: defineComponent$4,createVNode:_createVNode$7} = await importShared('vue');
...
var stdin_default$5 = defineComponent$4({
  ...
  setup(props, {
    ...
    const style = computed$3(() => mapThemeVarsToCSSVars(extend({}, props.themeVars, props.theme === "dark" ? props.themeVarsDark : props.themeVarsLight)));
    if (inBrowser$1) {
      const addTheme = () => {
      ...
      watch$6(() => props.theme, (newVal, oldVal) => {
        if (oldVal) {
          removeTheme(oldVal);
        }
        addTheme();
      ...
      watch$6(() => props.themeVarsScope, (newScope, oldScope) => {
        if (oldScope === "global") {
...
const {inject: inject$1,computed: computed$2,defineComponent: defineComponent$3,createVNode:_createVNode$6,mergeProps:_mergeProps$4} = await importShared('vue');
...
var stdin_default$4 = defineComponent$3({
  ...
  setup(props, {
    ...
    const classPrefix = computed$2(() => props.classPrefix || (config == null ? void 0 : config.iconPrefix) || bem$3());
    return () => {
      const {
        tag,
        dot,
      ...
      return _createVNode$6(Badge, _mergeProps$4({
        "dot": dot,
        "tag": tag,
        ...
        default: () => {
          var _a;
          return [(_a = slots.default) == null ? void 0 : _a.call(slots), isImageIcon && _createVNode$6("img", {
            "class": bem$3("image"),
            "src": name2
          }, null)];
        }
...
const {watch: watch$5,onBeforeUnmount,onDeactivated: onDeactivated$1} = await importShared('vue');
...
const useScopeId = () => {
  var _a;
  const { scopeId } = ((_a = getCurrentInstance$3()) == null ? void 0 : _a.vnode) || {};
  return scopeId ? { [scopeId]: "" } : null;
};

const {ref: ref$6,defineComponent: defineComponent$2,Teleport: Teleport$1,Transition: Transition$1,vShow:_vShow$2,mergeProps:_mergeProps$3,createVNode:_createVNode$5,withDirectives:_withDirectives$2} = await importShared('vue');
...
var stdin_default$2 = defineComponent$2({
  ...
  setup(props, {
    ...
    const renderOverlay = lazyRender(() => {
      ...
      return _withDirectives$2(_createVNode$5("div", _mergeProps$3({
        "ref": root,
        "style": style,
        "class": [bem$2(), props.className]
      }, attrs), [(_a = slots.default) == null ? void 0 : _a.call(slots)]), [[_vShow$2, props.show]]);
    });
    useEventListener("touchmove", onTouchMove, {
      target: root
    });
    return () => {
      const Content = _createVNode$5(Transition$1, {
        "name": "van-fade",
        "appear": true
      }, {
      ...
      if (props.teleport) {
        return _createVNode$5(Teleport$1, {
          "to": props.teleport
        }, {
          default: () => [Content]
        });
...
const {ref: ref$5,watch: watch$3,provide,Teleport,nextTick: nextTick$2,computed: computed$1,onMounted: onMounted$1,Transition,onActivated,onDeactivated,defineComponent: defineComponent$1,mergeProps:_mergeProps$2,createVNode:_createVNode$4,vShow:_vShow$1,withDirectives:_withDirectives$1,Fragment:_Fragment$1} = await importShared('vue');
  ...
  setup(props, {
    ...
    const renderOverlay = () => {
      if (props.overlay) {
        ...
        return _createVNode$4(Overlay, _mergeProps$2(overlayProps, useScopeId(), {
    ...
    const renderPopup = lazyRender(() => {
      ...
      return _withDirectives$1(_createVNode$4("div", _mergeProps$2({
        "ref": popupRef,
        "style": style.value,
        "role": "dialog",
        "tabindex": 0,
        ...
        "onKeydown": onKeydown
      }, attrs, useScopeId()), [(_a = slots.default) == null ? void 0 : _a.call(slots), renderCloseIcon()]), [[_vShow$1, show]]);
    });
    ...
    return () => {
      if (props.teleport) {
        return _createVNode$4(Teleport, {
          "to": props.teleport
        }, {
          default: () => [renderOverlay(), renderTransition()]
        });
      }
      return _createVNode$4(_Fragment$1, null, [renderOverlay(), renderTransition()]);
    };
  }
});
...
const {defineComponent,mergeProps:_mergeProps$1,createVNode:_createVNode$3} = await importShared('vue');
...
var stdin_default = defineComponent({
  ...
  setup(props, {
    ...
    return () => _createVNode$3(Popup, _mergeProps$1({
...
const {mergeProps:_mergeProps,createVNode:_createVNode$2} = await importShared('vue');
let timer;
let instance;
...
function initInstance() {
  ({
    ...
    setup() {
      ...
      return () => _createVNode$2(stdin_default, _mergeProps(state, {
 ...
 * @license MIT
 */
const {hasInjectionContext,inject,toRaw,watch: watch$2,unref,markRaw,effectScope,ref: ref$4,isRef,isReactive,getCurrentScope,onScopeDispose,getCurrentInstance: getCurrentInstance$2,reactive,toRef,nextTick: nextTick$1,computed,toRefs} = await importShared('vue');
let activePinia;
...
function createSetupStore($id, setup, options = {}, pinia, hot, isOptionsStore) {
  ...
  const partialStore = {
    ...
    $subscribe(callback, options2 = {}) {
      ...
      const stopWatcher = scope.run(() => watch$2(() => pinia.state.value[$id], (state) => {
...
const {getCurrentInstance: getCurrentInstance$1,ref: ref$3,nextTick} = await importShared('vue');
...
watch$1(() => mqttStore.doorState, (v) => {
    animationName.value = v === 1 && 'stop' || v === 3 && 'close' || v === 2 && 'open';
...
return (_ctx, _cache) => {
  return (_openBlock$2(), _createElementBlock$2("svg", _hoisted_1$2, [
    _createElementVNode$1("g", null, [
      _cache[0] || (_cache[0] = _createElementVNode$1("path", {
        stroke: "null",
        id: "svg_1",
        class: "selected",
        "data-spm-anchor-id": "a313x.search_index.0.i2.5fa23a81LNWuQc",
        "p-id": "21313",
      ...
      _createElementVNode$1("animateTransform", {
        attributeName: "transform",
        type: "translate",
        from: `${(animationName.value === 'open') ? 0 : animationName.value === 'stop' ? 240 : 600} 0`,
        to: `${(animationName.value === 'close') ? 0 : animationName.value === 'stop' ? 240 : 600} 0`,
        repeatCount: "indefinite",
        dur: "5s"
      }, null, 8, _hoisted_2$1)
    ]),
    _cache[1] || (_cache[1] = _createElementVNode$1("g", null, [
...
const {createElementVNode:_createElementVNode,resolveComponent:_resolveComponent,createVNode:_createVNode$1,createTextVNode:_createTextVNode,withCtx:_withCtx,unref:_unref,renderList:_renderList,Fragment:_Fragment,openBlock:_openBlock$1,createElementBlock:_createElementBlock$1,toDisplayString:_toDisplayString,vShow:_vShow,withDirectives:_withDirectives,normalizeStyle:_normalizeStyle} = await importShared('vue');


const _hoisted_1$1 = { class: "flex flex-col w-[100vw] h-[100vh] max-w-[600px]" };
...
const _hoisted_9 = { class: "p-8 flex flex-col gap-4 bg-[#F7F8FC] rounded-[20px]" };
const _hoisted_10 = { class: "flex-1 h-[100px] flex justify-center items-center" };
const _hoisted_11 = { class: "w-[90vw] h-[45vw] relative" };
const _hoisted_12 = { class: "p-0 text-center text-[#1989FA]" };
const {getCurrentInstance,onMounted,onUnmounted,ref: ref$1,watch} = await importShared('vue');
...
const setStateFn = (state) => {
  animationName.value = (state === 1 && 'stop') || (state === 2 && 'open') || (state === 3 && 'close');
...
return (_ctx, _cache) => {
  ...
  return (_openBlock$1(), _createElementBlock$1("div", _hoisted_1$1, [
    _createVNode$1(_component_van_popup, {
      show: showLogin.value,
      "onUpdate:show": _cache[4] || (_cache[4] = $event => ((showLogin).value = $event)),
      style: { padding: '64px', borderRadius: '20px' }
    }, {
      default: _withCtx(() => [
        _createElementVNode("div", _hoisted_2, [
          _cache[12] || (_cache[12] = _createElementVNode("div", null, "请登陆", -1)),
          _createVNode$1(_component_van_field, {
          ...
          _createVNode$1(_component_van_button, {
            onClick: _cache[2] || (_cache[2] = $event => (showLogin.value = false))
          }, {
            default: _withCtx(() => [...(_cache[10] || (_cache[10] = [
              _createTextVNode("登陆", -1)
            ]))]),
            _: 1
          }),
          _createVNode$1(_component_van_button, {
            onClick: _cache[3] || (_cache[3] = $event => (showLogin.value = false))
          }, {
    ...
    _createVNode$1(_component_van_popup, {
      ...
      "onUpdate:show": _cache[5] || (_cache[5] = $event => ((uplogShow).value = $event)),
      position: "bottom",
      style: { height: '60%' }
    }, {
      default: _withCtx(() => [
        _createElementVNode("div", null, [
          _cache[13] || (_cache[13] = _createElementVNode("div", { class: "text-center m-2" }, "升级日志", -1)),
          _createElementVNode("div", _hoisted_3, [
            (_openBlock$1(true), _createElementBlock$1(_Fragment, null, _renderList(_unref(uplogJson), (item, index) => {
              return (_openBlock$1(), _createElementBlock$1("div", {
                key: index,
                class: "mb-4"
              }, [
                _createElementVNode("div", _hoisted_4, [
                  _createElementVNode("strong", null, _toDisplayString(item.version), 1),
                  _withDirectives(_createElementVNode("span", _hoisted_5, "当前版本", 512), [
                    [_vShow, _unref(useStore).version === item.version]
                  ]),
                  _withDirectives(_createElementVNode("span", { class: "bg-[#1989FA] text-[#ffffff] px-2 rounded-2xl" }, _toDisplayString(item.type), 513), [
                    [_vShow, item.type]
                  ])
                ]),
                _createElementVNode("div", null, _toDisplayString(item.date), 1),
                (_openBlock$1(true), _createElementBlock$1(_Fragment, null, _renderList(item.list, (it, idx) => {
                  return (_openBlock$1(), _createElementBlock$1("div", {
                    key: idx,
                    class: "pl-4 p-1"
                  }, [
                    _createElementVNode("div", null, _toDisplayString(it.title), 1),
                    (_openBlock$1(true), _createElementBlock$1(_Fragment, null, _renderList(it.content, (i, j) => {
                      return (_openBlock$1(), _createElementBlock$1("div", {
                        key: j,
                        class: "pl-4"
    ...
    _createElementVNode("div", _hoisted_6, [
      _createElementVNode("div", _hoisted_7, [
        _createElementVNode("div", _hoisted_8, [
          _cache[14] || (_cache[14] = _createElementVNode("strong", null, "芯翼达院门", -1)),
          _createElementVNode("span", {
            style: _normalizeStyle({ color: stateTextClaComp.value }),
            onClick: mqttRetry
          }, _toDisplayString(statusMattKeys[_unref(mqttStore).state]?.title ||
            '未知'), 5)
        ]),
        _createElementVNode("div", _hoisted_9, [
          _createVNode$1(_component_van_button, {
            ...
            size: "large",
            onClick: _cache[6] || (_cache[6] = $event => (setStateFn(2)))
          }, {
            default: _withCtx(() => [...(_cache[15] || (_cache[15] = [
              _createTextVNode("开", -1)
            ]))]),
            _: 1
          }, 8, ["loading"]),
          _createVNode$1(_component_van_button, {
            ...
            loading: _unref(mqttStore).btnLoading,
            size: "large",
            onClick: _cache[7] || (_cache[7] = $event => (setStateFn(1)))
          }, {
            default: _withCtx(() => [...(_cache[16] || (_cache[16] = [
              _createTextVNode("停", -1)
            ]))]),
            _: 1
          }, 8, ["loading"]),
          _createVNode$1(_component_van_button, {
            ...
            loading: _unref(mqttStore).btnLoading,
            size: "large",
            onClick: _cache[8] || (_cache[8] = $event => (setStateFn(3)))
          }, {
            default: _withCtx(() => [...(_cache[17] || (_cache[17] = [
              _createTextVNode("关", -1)
            ]))]),
            _: 1
          }, 8, ["loading"])
        ])
    ...
    _createElementVNode("div", _hoisted_10, [
      _createElementVNode("div", _hoisted_11, [
        _createVNode$1(_sfc_main$2, {
          ...
          class: "w-full h-full"
        }, null, 8, ["animationName"])
      ])
    ]),
    _createElementVNode("div", _hoisted_12, [
      _createVNode$1(_component_van_icon, { name: "warning" }),
      _cache[18] || (_cache[18] = _createTextVNode("真实状态以实物为准", -1))
    ]),
    _createElementVNode("div", {
      class: "p-2 text-center text-[#cccccc]",
      onClick: _cache[9] || (_cache[9] = $event => (uplogShow.value = true))
    }, "V0.0.1")
  ]))
}
}
...
const compHome = /*#__PURE__*/_export_sfc(_sfc_main$1, [['__scopeId',"data-v-bd975769"]]);
...
export { isObject as $, useEventListener as A, BORDER_SURROUND as B, raf as C, cancelRaf as D, getScrollTop as E, setScrollTop as F, inBrowser$1 as G, HAPTICS_FEEDBACK as H, Icon as I, onMountedOrActivated as J, makeNumericProp as K, useScrollParent as L, unitToPx as M, getZIndexStyle as N, isHidden as O, Popup as P, usePageVisibility as Q, doubleRaf as R, BORDER_TOP_BOTTOM as S, setRootScrollTop as T, getElementTop as U, callInterceptor as V, flat as W, isSameValue as X, BORDER_UNSET_TOP_BOTTOM as Y, FORM_KEY as Z, getRootScrollTop as _, windowHeight as a, isFunction as a0, isPromise as a1, CUSTOM_FIELD_INJECTION_KEY as a2, toArray as a3, formatNumber as a4, resetScroll as a5, makeNumberProp as a6, mountComponent as a7, usePopupState as a8, useCustomFieldValue as a9, useMqttStore as aA, useUserStore as aB, createPinia as aC, isMobile as aa, getScrollParent as ab, padZero as ac, useToggle as ad, isDate as ae, useScopeId as af, useLazyRender as ag, stdin_default$5 as ah, useCountDown as ai, noop$1 as aj, BORDER_TOP as ak, BORDER_LEFT as al, useClickAway as am, getContainingBlock as an, stdin_default$3 as ao, useLockScroll as ap, BORDER as aq, LONG_PRESS_START_TIME as ar, BORDER_BOTTOM as as, stopPropagation as at, BORDER_RIGHT as au, addNumber as av, Locale as aw, Notify as ax, Overlay as ay, showNotify as az, useChildren as b, createNamespace as c, withInstall as d, _sfc_main as default, extend as e, addUnit as f, getSizeStyle as g, useParent as h, useExpose as i, unknownProp as j, Badge as k, pick as l, makeStringProp as m, numericProp as n, onPopupReopen as o, preventDefault as p, popupSharedProps as q, makeArrayProp as r, popupSharedPropKeys as s, truthProp as t, useRect as u, isDef as v, windowWidth as w, clamp as x, makeRequiredProp as y, useTouch as z };
